...
>[!IMPORTANT]
>
>Een nieuwe en gestroomlijnde [&#x200B; Report Builder &#x200B;](/help/analyze/report-builder/rb-overview.md) is beschikbaar sinds 16 Oktober, 2024. Deze Report Builder wordt ondersteund door macOS-, Windows- en webbrowsers en kan worden gebruikt met Adobe Analytics en Customer Journey Analytics.
>Deze verouderde Report Builder-invoegtoepassing werkt nog steeds. U kunt [&#x200B; uw erfeniswerkboeken &#x200B;](/help/analyze/report-builder/convert-workbooks.md) in nieuwe Report Builder omzetten.
...
## Customer Journey Analytics voor videodemonstratie {#videocja}

Deze video demonstreert de functionaliteit met Customer Journey Analytics. De functionaliteit is echter ook beschikbaar in Adobe Analytics. Ben zich bewust van de verschillen in terminologie tussen Adobe Analytics en Customer Journey Analytics (bijvoorbeeld *bezoeken* tegenover *zittingen*).
...
* **Bezoek**: Zoekt naar omzettingen van het werkingsgebied van de bezoekcontainer. Wanneer **[!UICONTROL Visit]** wordt geselecteerd, wordt het [&#x200B; terugkijkvenster van de Attributie &#x200B;](#atribution-lookback-window) automatisch geplaatst aan **[!UICONTROL Reporting window]** en kan niet worden veranderd.
...
|---|---|---|---|
| Eerste aanraking | Bezoek | Rapportagevenster | Attributie kijkt alleen naar het derde bezoek. Tussen e-mail en display was e-mail de eerste, dus e-mail krijgt 100% krediet voor de aankoop van $50. |
...
| Lineair | Bezoek | Rapportagevenster | Krediet wordt verdeeld tussen e-mail en weergave. Beide kanalen krijgen elk $25 krediet. |
...
>[!WARNING]
>
>De invoerder van de classificatie zal op **31 augustus, 2026** worden afgekeurd. Gelieve te schakelen om de [&#x200B; ervaring van de Classificatiereeksen &#x200B;](/help/components/classifications/sets/overview.md) te gebruiken om voortdurende functionaliteit te verzekeren.
>
...
>[!WARNING]
>
>De de regelbouwer van de classificatie zal op **28 februari, 2027** worden afgekeurd. Gelieve te schakelen om de [&#x200B; ervaring van de reeksen van de Classificatie te gebruiken de regels &#x200B;](/help/components/classifications/sets/manage/rules.md), zodra beschikbaar, om voortdurende functionaliteit te verzekeren.
>
