...
Clienttips zijn op 2 maart 2023 opgenomen in het zoekproces van het analyseapparaat. Deze wijziging geldt voor AppMeasurement- en Web SDK-implementaties.
...
* [Browsertype](/help/components/dimensions/browser-type.md)
* [Besturingssysteem](/help/components/dimensions/operating-systems.md)
* [Typen besturingssystemen](/help/components/dimensions/operating-system-types.md)
* [Mobiel apparaat en type mobiel apparaat](/help/components/dimensions/mobile-dimensions.md)
...
+++**waarom zie ik een browser versieaantal van 999.99?**

Klanten voeren soms tests uit met ongeldige versienummers van browsers of apparaatbesturingssystemen, die een willekeurig aantal van meer dan 100.000 kunnen zijn. Om grote aantallen ongeldige browser of apparatenwerkend systeemversieaantallen op een bepaalde dag te vermijden, worden om het even welke versieaantallen die meer dan 100.000 zijn verpakt samen en vastgezet aan versienummer 999.99.
