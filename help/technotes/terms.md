...
* **kaart van de Activiteit:** een browser elektrisch toestel dat toont welke gebieden op uw plaats het meest werden geklikt. Zie [ Activity Map ](/help/analyze/activity-map/overview.md) in de Analysegebruikersgids.
* **Admin console:** kan naar verwijzen:
   ...
   * De beheerconsole van de Adobe, waar de producttoegang wordt voorzien en de gebruikerstoestemmingen worden beheerd. Zie [ Admin Console ](/help/admin/admin-console/home.md) in de Admin gebruikersgids.
...
* **Uitsplitsing:** laat u een afmeting binnen de context van een andere afmeting bekijken. Zie {de afmetingen van 0} Onderbreking ](/help/analyze/analysis-workspace/components/dimensions/t-breakdown-fa.md) in de Analysegebruikersgids.[
...
* **Clickmap:** niet meer gebruikt. Een verouderde browserplug-in die aangeeft op welke gebieden op uw site het meest is geklikt. Dit instrument is ingetrokken ten gunste van Activity Map.
* **Clickstream gegevensvoer:** zie de voer van Gegevens.
* **Cohort:** een groep mensen die gemeenschappelijke kenmerken over een bepaalde periode delen. Zie [ wat de Analyse van de Cohort is?](/help/analyze/analysis-workspace/visualizations/cohort-table/cohort-analysis.md) in de gebruikershandleiding Analyze.
* **server van de Inzameling:** zie de server van de Gegevensverzameling.
* **Component:** de Componenten in Analysis Workspace bestaan uit afmetingen, metriek, segmenten, en datumwaaiers die u kunt slepen-en-daling op een project. Zie [ Overzicht van Componenten ](/help/analyze/analysis-workspace/components/analysis-workspace-components.md) in de Analysegebruikersgids.
...
* **variabele van de Omzetting:** ook gekend als eVars. Slaat een douanewaarde op, en bewaart de veranderlijke waarde tot het verloopt. Zie de [ eVar ](/help/components/dimensions/evar.md) dimensie in de gebruikersgids van Componenten.
...
* **Data Workbench:** vroeger gekend als Inzicht. Ontworpen voor het verzamelen, verwerken, analyseren en visualiseren van data van zowel online als offline klanteninteracties via meerdere kanalen.
* **Dimension:** een componenttype dat veranderlijke waarden, zoals tekst bevat. Voorbeelden zijn Paginanaam, Trackingcode of Referentiedomein. Een metrisch is typisch zijn tegenhanger.
...
* **ExcelClient:** niet meer gebruikt als termijn. De naam van de voorganger van de Report Builder.
...
* **Stroom:** een type van visualisatie in Analysis Workspace dat toont welke wegen de gebruikers op uw plaats namen. Zie [ visualisatie van de Stroom ](/help/analyze/analysis-workspace/visualizations/c-flow/flow.md) in de Analysegebruikersgids.
* **Genesis:** niet meer gebruikt als termijn. De vroegere naam Data Connectors.
...
* **verzoek van het Beeld:** een transparant 1x1 pixelbeeld dat wordt gebruikt om met de servers van de de gegevensinzameling van de Adobe te communiceren. Een website vraagt deze onzichtbare afbeelding aan met een lange queryreeks die gegevens bevat. De Adobe retourneert de onzichtbare afbeelding en parseert de ontvangen queryreeks.
* **Inzicht:** kan naar verwijzen:
...
* **Lancering:** niet meer gebruikt als termijn. De verkorte oude naam van tags in Adobe Experience Platform, de huidige implementatieoplossing van Adobe. Zie [ overzicht van Markeringen ](https://experienceleague.adobe.com/docs/experience-platform/tags/home.html) in de gebruikersgids van Adobe Experience Platform.
...
* **Mobiele Diensten:** een gepensioneerd product van de Adobe dat mobiele marketing mogelijkheden voor mobiele toepassingen van over Adobe Experience Cloud samenbracht, latend u begrijpen en gebruikersinteractie met uw toepassingen verbeteren.
...
* **Omniture:** niet meer gebruikt als termijn. De organisatie die Adobe Analytics bezat voordat zij in 2009 door Adobe werd overgenomen.
...
* **Regels van de Verwerking:** kan verwijzen naar:
   * Verwerkingsregels, een manier om gegevensverzameling te veranderen gebruikend bepaalde regels in de Admin Console. Zie [ Regels van de Verwerking ](/help/admin/admin/c-manage-report-suites/c-edit-report-suites/general/c-processing-rules/processing-rules.md) in de Admin gebruikersgids.
...
* **Report Builder:** toe:voegen-binnen Microsoft Excel die u aangepaste verzoeken van de gegevens van Adobe Analytics laat bouwen.
...
* **Rapporten &amp; Analytics:** vroeger gekend als SiteCatalyst. Browseroplossing voor rapportage en analyse. Starter in het pakket Analytics. Dit hulpmiddel is [ eind-van-opgeheven ](https://experienceleague.adobe.com/docs/discontinued/using/reports-and-analytics.html) geweest.
...
* **s.t ():** De naam van de functie in een bibliotheek van het AppMeasurement die een verzoek van het paginabeeld verzendt. Sommige bibliotheken met AppMeasurementen gebruiken in plaats daarvan `s.track()` . Zie [ t ](../implement/vars/functions/t-method.md) in de de gebruikersgids van het Uitvoeren.
* **s <span>.</span> tl ():** De naam van de functie in een bibliotheek van het AppMeasurement die een verzoek van het verbindingsvolgen beeld verzendt. Sommige bibliotheken met AppMeasurementen gebruiken in plaats daarvan `s.trackLink()` . Zie [ tl ](../implement/vars/functions/tl-method.md) in de de gebruikersgids van het Uitvoeren.
...
* **Satelliet:** niet meer gebruikt als termijn. De vroegere productnaam voor Dynamic Tag Management.
