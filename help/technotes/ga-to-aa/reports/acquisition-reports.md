...
In Adobe Analytics worden deze rapporten ook wel **marketingkanalen** genoemd. Zij vereisen wat basis aanvankelijke opstelling, maar staan een veel meer aangepaste mening van kanalen toe.
...
Deze pagina gaat ervan uit dat de gebruiker een basiskennis heeft van het gebruik van Analysis Workspace. Zie [Een basisrapport maken in Analysis Workspace voor gebruikers](create-report.md) van Google Analytics als u het gereedschap nog niet kent in Adobe Analytics.
...
1. Zoek in het menu Componenten de dimensie **Marketingkanaal** en sleep deze naar het grote tabelgebied voor vrije vorm met de naam &#39;Hier een Dimension neerzetten&#39;.
...
De functie voor het analyseren van advertenties moet zijn geconfigureerd om gegevens te retourneren. Raadpleeg de Help bij [](/help/integrate/c-advertising-analytics/overview.md) Advertising Analytics voor meer informatie over het inschakelen van deze extra afmetingen in Analysis Workspace.
...
1. Zoek in het menu Componenten de dimensie Refererend domein **** en sleep deze naar het grote tabelgebied Vrije vorm met de naam &#39;Hier een Dimension neerzetten&#39;.
...
1. Zoek in het menu Componenten de afmetingen voor de **invoerpagina** en sleep deze naar het grote tabelgebied voor vrije vorm met de naam &#39;Hier een Dimension neerzetten&#39;.
2. Zoek in het menu Componenten de **bezoeken van het segment Sociale sites** en sleep in het kleine gebied net boven de vrije-vormtabel met het label &#39;Hier een segment neerzetten&#39;.
3. Sleep de gewenste metriek naar de werkruimte naast de automatisch gemaakte metrische **Voorvallen** . Zie de [Metrische vertaalgids](common-metrics.md) voor details over hoe te om elke respectieve metrisch te verkrijgen.
...
3. Zoek de afmetingen voor **pagina** &#39;s en klik op het pictogram Pijl om de paginawaarden weer te geven. Dimension-items zijn gekleurd geel.
...
1. Zoek in het menu Componenten de dimensie **Code** bijhouden en sleep deze naar het grote tabelgebied voor vrije vorm met de naam &#39;Hier een Dimension neerzetten&#39;.
2. Sleep de gewenste metriek naar de werkruimte naast de automatisch gemaakte metrische **Voorvallen** . Zie de [Metrische vertaalgids](common-metrics.md) voor details over hoe te om elke respectieve metrisch te verkrijgen.
...
1. Zoek in het menu Componenten het trefwoord **Zoeken - Betaalde** dimensie en sleep het naar het grote tabelgebied Vrije vorm met het label &#39;Hier een Dimension neerzetten&#39;.
2. Sleep de gewenste metriek naar de werkruimte naast de automatisch gemaakte metrische **Voorvallen** . Zie de [Metrische vertaalgids](common-metrics.md) voor details over hoe te om elke respectieve metrisch te verkrijgen.
...
1. Zoek in het menu Componenten het trefwoord **Zoeken - Natuurlijk** en sleep het naar het grote tabelgebied Vrije vorm met het label &#39;Hier een Dimension neerzetten&#39;.
2. Sleep de gewenste metriek naar de werkruimte naast de automatisch gemaakte metrische **Voorvallen** . Zie de [Metrische vertaalgids](common-metrics.md) voor details over hoe te om elke respectieve metrisch te verkrijgen.
