...
* **Zelfcontrole met behulp van foutopsporing**: U kunt de pagina&#39;s op uw site controleren met [Adobe](https://experienceleague.adobe.com/docs/debugger/using/experience-cloud-debugger.html?lang=nl-NL) of een andere pakketmonitor. Het gebruiken van debugger laat u uw implementatie bevestigen om beeldverzoeken correct met de juiste variabelen te verzekeren.
