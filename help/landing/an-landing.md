...
Nadat u zich bij Adobe Experience Cloud en Analytics hebt aangemeld, schakelt u de schakelknop [!UICONTROL New landing page - Beta] linksonder in. Toegang tot de schakelknop is gebruikersspecifiek per organisatie, niet bedrijfsspecifiek.

![](assets/new-landing.png)

## De nieuwe menustructuur wordt weergegeven

Het bovenste menu en het linkerspoor zijn veranderd.

![](assets/top-menus.png)

* Wijzigingen in het menu Analytics: Het **[!UICONTROL Reports]** bovenste menu is er niet meer. De meeste rapporten staan nu in het menu [!UICONTROL Reports] in het linkerspoor.
* De linkerspoorstaaf heeft drie tabbladen: [!UICONTROL Projects], [!UICONTROL Reports] en [!UICONTROL Learning]. Wij bespreken elk van hen meer in detail in de volgende secties.

### Terminologie

Houd rekening met enkele wijzigingen in de terminologie:
...
* **[!UICONTROL Reports]** verwijst naar alles wat vooraf is samengesteld door Adobe, zoals rapporten in Rapporten &amp; Analytics en sjablonen in Workspace. [!UICONTROL Reports] zijn ook rapportmalplaatjes die uw bedrijf voor u heeft gebouwd.
* **[!UICONTROL Templates]** wordt niet meer gebruikt als een term voor vooraf gebouwde Workspace-projecten met Adobe Ze zijn nu onder [!UICONTROL Reports].

## Navigeren op het tabblad [!UICONTROL Projects] {#navigate-projects}

[!UICONTROL Projects] fungeert als de  [!UICONTROL Workspace] startpagina. Alle Workspace-projecten worden hier weergegeven, inclusief Mobiele scorecards.
...
| --- | --- |
| ... Meer | Hiermee kunt u [!UICONTROL View Tutorials] en [Gebruikersvoorkeuren bewerken](/help/analyze/analysis-workspace/user-preferences.md). |
| Project maken | Met het keuzemenu kunt u een [!UICONTROL Workspace project] of [!UICONTROL Mobile project] maken. |
| Minder/meer tonen | Hiermee schakelt u tussen het niet weergeven en weergeven van de banner: ![](assets/top-banner.png) |
| Leeg project | Creeert een leeg [Werkruimteproject](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/home.html?lang=en) voor u om te bevolken. |
| Lege mobiele scorecard | Hiermee maakt u een lege [mobiele scorecard](https://experienceleague.adobe.com/docs/analytics/analyze/mobapp/curator.html?lang=en) om te vullen. |
...
| Kolomkiezer | Als u kolommen wilt toevoegen aan of verwijderen uit de lijst met projecten, kunt u dit doen door ze te selecteren of te deselecteren. |
| &lt;> | Deze knoop in een project van de Werkruimte of een rapport neemt u terug naar uw meest recente het landen paginaconfiguratie. De paginasonfiguratie die u had toen u de openingspagina verliet, zal aanhouden wanneer u terugkeert. |

## Navigeren op het tabblad [!UICONTROL Reports] {#navigate-reports}

Het tabblad [!UICONTROL Reports] consolideert drie sets rapporten:

* De vooraf gebouwde [!UICONTROL Workspace] sjablonen die zich eerder onder [!UICONTROL Workspace] > [!UICONTROL Project] > [!UICONTROL New] bevonden. Adobe gebruikt in deze context niet langer het woord &quot;sjabloon&quot;.
* De meeste vooraf gebouwde rapporten onder vorige Adobe Analytics [!UICONTROL Reports] hoogste menu. Deze rapporten worden nu weergegeven in [Analysis Workspace](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/home.html?lang=en).
...
Hier zijn de nieuwe menu&#39;s en hun submenu&#39;s. Als u geen specifiek rapport kunt vinden, doe &quot;Onderzoek op pagina&quot;om het te vinden.
...
| **[!UICONTROL Company reports]** | Meldt dat uw bedrijf voor uw gebruik heeft gemaakt. |
...
1. Selecteer het rapport u, bijvoorbeeld, onder [!UICONTROL Most popular] wilt bekijken, selecteren [!UICONTROL Pages] rapport.
1. Klik rechts op **[!UICONTROL Open report]**.

   ![](assets/pages-report.png)

1. Het rapport Pagina&#39;s, zoals weergegeven in Analysis Workspace, toont twee [visualisaties](/help/analyze/analysis-workspace/visualizations/freeform-analysis-visualizations.md) ([Staafdiagram](/help/analyze/analysis-workspace/visualizations/bar.md) en [Samenvattingsnummer](/help/analyze/analysis-workspace/visualizations/summary-number-change.md)) en een [Vrije-vormtabel](/help/analyze/analysis-workspace/visualizations/freeform-table/freeform-table.md). De gebruikte metrische waarde is Voorvallen.
1. Hier hebt u meerdere opties. Hier volgen enkele opties:

   * U kunt het rapport ongewijzigd gebruiken.
   * U kunt een of meer segmenten naar de neerzetzone Segment bovenaan slepen. Sleep bijvoorbeeld het segment [!UICONTROL Mobile Customers] en bekijk de wijziging in de resultaten.
...
* Voor nieuwe gebruikers, adviseren wij [de video van de Opleiding ](https://www.youtube.com/watch?v=lCH1Kl1q9Wk) die u door het bouwen van een nieuw project loopt.
* Hier volgt een koppeling naar de [volledige Analysis Workspace-documentatie](/help/analyze/analysis-workspace/home.md).
* Hier volgt de complete [YouTube-afspeellijst voor Analysis Workspace](https://www.youtube.com/playlist?list=PL2tCx83mn7GuNnQdYGOtlyCu0V5mEZ8sS).
...
* Met de omleiding [!UICONTROL Workspace Fundamentals] gaat u rechtstreeks naar Workspace en doorloopt u de schermindeling Werkruimte en waar u de meest voorkomende handelingen kunt zoeken/uitvoeren. Deze rondleiding kan ook op elk gewenst moment rechtstreeks in Workspace worden gestart via de pop-up voor de knopinfo in de koptekst van het deelvenster.

* Als u op een video/rondleiding klikt, wordt de tag **[!UICONTROL Viewed]** toegevoegd. Met deze tag kunt u de voortgang van de leerinhoud volgen. U kunt op het label klikken en het verdwijnt, voor het geval u de inhoud nog niet hebt voltooid.

* Met de knop **[!UICONTROL Learn more]** op het modaal videoscherm gaat u naar een Adobe Experience League-documentatiepagina met meer Help-inhoud die gerelateerd is aan de video die u net hebt bekeken.  **[!UICONTROL View more videos]** Hiermee gaat u naar de volledige Analysis Workspace YouTube-afspeellijst.

## Nieuwe openingspagina - Veelgestelde vragen {#landing-faq}

| Vraag | Antwoord |
| --- | --- |
| Waar zijn de malplaatjes die ik aan het zien in Werkruimte gewend ben? | Deze sjablonen worden gegroepeerd onder het tabblad [!UICONTROL Reports]. |
...
| Kunnen beheerders deze nieuwe bestemmingspagina voor hun gebruikers aanwijzen? | Nee, beheerders kunnen de nieuwe bestemmingspagina niet aanwijzen namens gebruikers. Individuele gebruikers moeten de schakeloptie zelf inschakelen. |
