---
description: Implementeer Adobe Analytics met Dynamic Tag Management door het Adobe Analytics-gereedschap te maken en de paginacode automatisch of handmatig te configureren. De automatische methode wordt aanbevolen voor de meeste gebruikers.
...
Implementeer Adobe Analytics met Dynamic Tag Management door het Adobe Analytics-gereedschap te maken en de paginacode automatisch of handmatig te configureren. De automatische methode wordt aanbevolen voor de meeste gebruikers.

>[!NOTE]
>
>Voor betere bezoekerscontrole, adviseren wij sterk dat u de Dienst [van de](https://docs.adobe.com/content/help/nl-NL/id-service/using/home.html)Identiteit toelaat.
...
<table id="table_1CFB53FE72E74CCB8CAA5D4E3873D286"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b>Automatisch</b> (aanbevolen): Gebruik dynamisch tagbeheer om de configuratie te beheren. Met deze methode wordt automatische synchronisatie van <span class="keyword"> Adobe Analytics</span> -rapportreeksen ingeschakeld via een <span class="keyword"> Experience Cloud</span> -aanmeldings- of Web Services-id en wordt de AppMeasurement-code beheerd. </p> <p>Nadat de accounts zijn verbonden, haalt Dynamic Tag Management de <span class="keyword"> Adobe Analytics</span> -rapportensuite-id's en -namen naar de interface van de gereedschapsconfiguratie, waardoor de implementatie van gereedschappen sneller verloopt en de kans op gebruikersfouten kleiner is. </p> <p> <p>Opmerking: U moet de optie <span class="wintitle"> Automatisch</span> kiezen als u een <span class="keyword"> Adobe Analytics Premium</span> -klant bent. </p> </p> <p>Vul de gebieden in specifiek voor automatische configuratie: </p> 
    <ul id="ul_8D9797B01E444B9C85B862A9F96B447C"> 
     <li id="li_0AC84C1F37B24C658F2178E50ECCC4B0"> <p> <b>Experience Cloud</b>: (Standaardinstelling) Hierbij wordt <span class="keyword"> Experience Cloud</span> Single Sign-On gebruikt. Geef uw Experience Cloud-id en wachtwoord op. </p> </li> 
...
Zie [Veelgestelde vragen over Adobe Analytics Tool](/help/implement/faq.md) voor meer informatie over dit hulpprogramma.

## Bestaande Adobe Analytics-gereedschappen bewerken {#section_148B16AF429B4949B06238D90635B726}

U kunt een bestaand Adobe Analytics-hulpprogramma bewerken om de configuratie-instellingen te wijzigen.
...
1. Bewerk de velden naar wens.
   ...
   De volgende tabel bevat alleen de elementen die afwijken van de elementen die beschikbaar zijn wanneer u een Analytics-gereedschap maakt, zoals hierboven beschreven. U kunt echter elk element op de pagina wijzigen, zoals in beide tabellen wordt beschreven.
