...
1. Voeg een Directe Regel van de Vraag toe die een baken Analytics gebruikend `websiteBot` als herkenningsteken in brand steken. In dit voorbeeld wordt een `s.tl`-aanroep gebruikt:

   ![websiteBot-id](assets/websitebot.png)

1. Vuur de Adobe Analytics - Vastgestelde Variabelen &amp; Adobe Analytics - verzend de acties van het Baken in de Directe regel van de Vraag.  In het volgende voorbeeld wordt een manier getoond om dit te doen:
