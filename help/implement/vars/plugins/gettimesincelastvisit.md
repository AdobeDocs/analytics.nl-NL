...
Met deze plug-in maakt u een cookie van de eerste fabrikant, genaamd `"s_tslv"` ingesteld op Unix timestamp van de huidige tijd. Het cookie verloopt na twee jaar inactiviteit.
