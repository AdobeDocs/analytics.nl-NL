...
| **4 <sup> de</sup>** | `fid` | De bezoeker heeft een bestaand [`s_fid` &#x200B;](https://experienceleague.adobe.com/nl/docs/core-services/interface/data-collection/cookies/analytics) cookie, of als `aid` en `mid` om welke reden dan ook niet kunnen worden ingesteld. |
