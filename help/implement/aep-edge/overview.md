...
De maximumgrootte voor een gegeven de veranderlijke lading van contextgegevens (met inbegrip van sleutels en waarden) is 32 KB. U kunt de grootte van deze lading verminderen door relevante gebieden aan te passen zodat zij door Adobe Analytics in de [`xdm`](xdm-var-mapping.md) of [`data`](data-var-mapping.md) voorwerpen worden erkend.
