...
| `xdm.device.colorDepth` | De hulp plaatst de ](/help/components/dimensions/color-depth.md) dimensie van de Diepte van de 0} Kleur.[ |
| `xdm.device.screenHeight` | De hulp plaatst de ](/help/components/dimensions/monitor-resolution.md) dimensie van de Resolutie van de Monitor 0}.[ |
| `xdm.device.screenWidth` | De hulp plaatst de ](/help/components/dimensions/monitor-resolution.md) dimensie van de Resolutie van de Monitor 0}.[ |
| `xdm.device.type` | Het type mobiel apparaat. |
| `xdm.environment.browserDetails.acceptLanguage` | De hulp plaatst de ](/help/components/dimensions/language.md) dimensie van de Taal 0} {.[ |
| `xdm.environment.browserDetails.cookiesEnabled` | Plaatst de ](/help/components/dimensions/cookie-support.md) dimensie van de Steun van het 0} Koekje. [ Geldige waarden zijn `Y` (de browser accepteert cookies) en `N` (de browser weigert cookies). |
...
| `xdm._experience.analytics.customDimensions.`<br/>`props.prop1`<br/>`[...]`<br/>`xdm._experience.analytics.customDimensions.`<br/>`props.prop75` | Plaatst de respectieve ](/help/components/dimensions/prop.md) dimensie van 0} Prop.[ |
...
| `xdm.placeContext.geo.stateProvince` | De ](/help/components/dimensions/us-states.md) dimensie van de Staten van 0} VS.[ |
...
| `xdm.web.webPageDetails.siteSection` | De ](/help/components/dimensions/site-section.md) dimensie van de Sectie van 0} Plaats.[ |
