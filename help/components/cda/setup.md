...
CDA wordt geleverd op uw cross-device rapportsuite door Adobe Engineering. Neem contact op met de klantenservice om dit proces te starten en bereid te zijn de volgende informatie te verstrekken:
...
* Welke methode van CDA wilt u gebruiken (op gebied-gebaseerde Stitching)
* Als u op het veld gebaseerde stitching wilt gebruiken, de prop of eVar die de gebruikersnaam bevat
