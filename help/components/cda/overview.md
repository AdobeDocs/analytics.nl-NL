...
Cross-Device Analytics (CDA) is een functie waarmee Analytics van een apparaat-centric mening in een persoon-centric mening wordt omgezet. Dit heeft tot gevolg dat analisten begrip hebben voor het gedrag van gebruikers in browsers, apparaten of apps. Adobe steunt [ op gebied-gebaseerde het stitching ](field-based-stitching.md) die slechts deterministische aanpassing aan verbindingsapparaten samen gebruikt.
...
Het gebruik van Analytics van het Interapparaat vereist [ op gebied-gebaseerd stitching ](field-based-stitching.md).
...
Cross-Device Analytics is een baanbrekende en robuuste functie, maar heeft beperkingen in de manier waarop deze kan worden gebruikt. [ op gebied-gebaseerde het stitching ](field-based-stitching.md) heeft ook zijn eigen specifieke beperkingen.
