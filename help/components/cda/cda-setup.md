---
title: Cross-device Analytics instellen
description: Leer hoe u Analytics voor meerdere apparaten instelt als u aan de voorwaarden voldoet.
...
# Cross-device Analytics instellen
...
>[!IMPORTANT]
>
>Aan alle voorwaarden moet worden voldaan voordat u deze stappen uitvoert. Als niet aan alle voorwaarden wordt voldaan, is de functie niet beschikbaar of werkt deze niet. Zie Analytics [voor](cda-home.md) andere apparaten voor voorwaarden en beperkingen.
...
1. Zoek de &quot;Reis-IQ: Cross-Device Analytics&quot;-sjabloon, klik vervolgens op [!UICONTROL Create].
