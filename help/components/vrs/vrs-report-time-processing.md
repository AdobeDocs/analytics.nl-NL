...
Zie ![&#x200B; VideoCheckedOut &#x200B;](/help/assets/icons/VideoCheckedOut.svg) [&#x200B; Beginnend een nieuw bezoek met gebeurtenis &#x200B;](https://experienceleague.adobe.com/nl/docs/analytics-learn/tutorials/components/virtual-report-suites/start-a-new-visit-on-any-event-in-virtual-report-suites){target="_blank"} voor een demo video.
...
De Verwerking van de Tijd van het rapport steunt niet alle metriek en dimensies beschikbaar in traditionele Analytics rapportering. Virtuele rapportsuites die gebruikmaken van Report Time Processing zijn alleen toegankelijk in Analysis Workspace en zijn niet toegankelijk in Data Warehouse, Report Builder, Data Feeds of de rapportage-API.

Bovendien verwerkt de Tijd van het Rapport slechts gegevens die uit binnen de rapporteringsdatumwaaier (die als &quot;datumvenster&quot;hieronder wordt bedoeld) komen. Dit betekent dat eVar-waarden die voor een bezoeker vóór de rapportdatumreeks zijn ingesteld op &quot;nooit verlopen&quot;, niet in de rapportagevensters blijven staan en niet in rapporten worden weergegeven. Dit betekent ook dat de metingen van de klantenloyaliteit uitsluitend gebaseerd zijn op de gegevens in de rapporteringsdatumwaaier en niet op de volledige geschiedenis voorafgaand aan de rapporteringsdatumwaaier.

De volgende afmetingen en metriek worden niet gesteund met de Verwerking van de Tijd van het Rapport:

* **Analytics voor Doel**
* **Analytics voor de dimensies/metriek van de Wolk van de Reclame**
* **Teller eVars**
