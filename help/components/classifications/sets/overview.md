...
* [**[!UICONTROL Classification Sets]**](set-manager.md): classificatiesets maken, bewerken en verwijderen.
...
1. [&#x200B; creeer een classificatiereeks &#x200B;](/help/components/classifications/sets/create.md) met abonnementen voor één of meerdere rapportreeks en zeer belangrijke afmetingscombinaties die producten identificeren. Bijvoorbeeld:
