...
Het belangrijkste verschil tussen classificatiesets en oudere classificaties is dat classificatiesets alle functionaliteit in één interface combineert, waarbij oudere classificaties op drie interfaces zijn gebaseerd.

### Oudere classificaties

![ Verouderde classificatie ](./assets/classifications-legacy.svg)
...
Met classificatiesets worden alle verouderde classificatiesamenvattingen in één geheel gecombineerd. Elk classificatieset definieert:
