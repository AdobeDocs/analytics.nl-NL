...
1. In de **[!UICONTROL Classification Set: _dialoog van de classificatiereeks_]**, selecteer het **[!UICONTROL Schema]** lusje. Dat tabblad bestaat uit de volgende interface-elementen:
