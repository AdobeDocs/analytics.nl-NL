...
Het schema voor een classificatieset definiëren:

1. Selecteer in Beheer **[!UICONTROL Classifications Sets]** de classificatieset waarvoor u het schema wilt bewerken.
1. In de **[!UICONTROL Classification Set: _dialoog van de classificatiereeks_]**, selecteer het lusje van het Schema. Dat tabblad bestaat uit de volgende interface-elementen:
...
| **[!UICONTROL Identity Name]** | De afgeleide naam door het systeem voor de classificatie. |
...
In de **[!UICONTROL Add a new classification for _classificatiereeks_]** dialoog, ga **[!UICONTROL Classification Name]** in en selecteer **[!UICONTROL Add]**. De classificatie wordt toegevoegd aan de lijst.
...
1. In het dialoogvenster **[!UICONTROL Add new classifications]** :
   ...
   * Selecteer **[!UICONTROL Browse]** en kies een bestand van uw computer of netwerk.
   ...
   Wanneer geen classificatie in de classificatiereeks voor een kolom wordt bepaald, wordt een alarm ![ Alarm ](/help/assets/icons/Alert.svg) getoond. In de waarschuwing wordt uitgelegd dat een classificatie niet aanwezig is in de bestaande set classificatieschema&#39;s en bij het importeren wordt gemaakt.
...
In de **[!UICONTROL Download data for _dialoog van de 0} classificatiereeks:_]**
...
1. Selecteer een optie in **[!UICONTROL Data Returned]** om te selecteren welke gegevens u wilt retourneren.
   ...
   * **[!UICONTROL Any columns empty]** retourneert een kolom met sleutelwaarden voor de bestaande classificatiegegevens. En kolommen zonder waarde voor classificatiegegevens waarvoor geen waarde bestaat.
...
1. Selecteer **[!UICONTROL Download]** om de classificatiegegevens te downloaden. U kunt het gedownloade dossier in de standaarddownloadfolder van uw browser vinden, en het dossier is genoemd <code><i> Reeks van de Classificatie </i>.<i> json </i>|<i> csv </i>|<i> tsv </i></code>. Als het dossier reeds bestaat, een opeenvolgingsaantal <code> (<i> x </i>)</code> wordt toegevoegd aan de bestandsnaam.<br/> als u opties hebt gespecificeerd die geen gegevens terugkeren, ziet u een **[!UICONTROL Notice]** dialoog die u informeert om de opties voor datumwaaier en teruggekeerde gegevens te veranderen.
...
In de **[!UICONTROL Download template for _dialoog van de 0} classificatiereeks:_]**
...
In de **[!UICONTROL Associate / Update Ingest Location for _dialoog van de 0} classificatiereeks:_]**
...
1. Als u een scheidingsteken wilt selecteren, selecteert u een optie in **[!UICONTROL List delimiter]** . De opties zijn:
   * **[!UICONTROL Comma ,]**
   * **[!UICONTROL Semicolon ;]**
   * **[!UICONTROL Colon :]**
...
Op de actiebalk staan acties die beschikbaar zijn voor de geselecteerde classificatieset. Beschikbare opties zijn:
...
| ![ anders noemen ](/help/assets/icons/Rename.svg) | **[!UICONTROL Rename]** | Wijzig de naam van een classificatie. In de **[!UICONTROL Rename: _classificatie_]** dialoog, ga een nieuwe naam in en selecteer **[!UICONTROL Rename]**. |
| ![ Schrapping ](/help/assets/icons/Delete.svg) | **[!UICONTROL Delete]** | Een classificatieset verwijderen. De **[!UICONTROL Delete _classificatie_]** dialoog verschijnt. Selecteer **[!UICONTROL Delete]** om de classificatieset te verwijderen. |
