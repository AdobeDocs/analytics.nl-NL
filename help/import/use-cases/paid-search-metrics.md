...
# Metrisch [!UICONTROL Paid Search] importeren met [!UICONTROL Data Sources]
...
In de stappen wordt uitgelegd hoe u een eenmalige import van Pay-Per-Click-gegevens instelt. Met [!UICONTROL Data Sources] kunnen echter gegevens worden geïmporteerd in de bestandsindeling die hier wordt beschreven. Afhankelijk van uw betaalde zoekplatform kunt u mogelijk periodieke exportbewerkingen (dagelijks, maandelijks, enz.) plannen, geautomatiseerde processen instellen om deze exportbewerkingen om te zetten in de bestandsindeling die Adobe Analytics nodig heeft, en deze bestanden uploaden naar Adobe Analytics voor de rapportage van betaalde zoekintegratie.
...
[!UICONTROL Success events] zijn handelingen die kunnen worden bijgehouden. U bepaalt wat een [!UICONTROL success event] is. Voor het bijhouden van [!UICONTROL paid search]-metriek willen we [!UICONTROL success events] rond [!UICONTROL clicks], [!UICONTROL impressions], [!UICONTROL total cost] en enable[!UICONTROL tracking codes] instellen.
...
De [!UICONTROL Data Source Activation Wizard] toont:
...
1. Selecteer de drie standaardmetriek: [!UICONTROL Impressions], [!UICONTROL Clicks] en [!UICONTROL Total Cost] en klik **[!UICONTROL Next]**.
1. Nu &quot;kaart&quot;deze nieuwe gegevensbron aan de douanegebeurtenissen die wij in [vormen Gebeurtenissen van het Succes](/help/admin/admin/c-success-events/t-success-events.md) hebben gecreeerd.
...
Wijs de geïmporteerde gegevensdimensie (kenmerk) toe aan het Adobe Analytics-kenmerk waarin u het wilt opslaan. Dit kan een standaardafmeting of een eVar zijn. Nadat u **[!UICONTROL Next]** klikt, worden de resulterende afbeeldingen getoond in de samenvatting:

   ![Samenvatting](assets/data-source-summary.png)

1. Klik op **[!UICONTROL Save]**.
1. Klik **[!UICONTROL Download]** om het malplaatjedossier voor deze gegevensbron te downloaden.
...
c. Controleer in Stap 1 van de wizard of **[!UICONTROL Delimited]** is geselecteerd en klik op **[!UICONTROL Next]**.
...
U kunt bijvoorbeeld de volgende [berekende metriek](https://experienceleague.adobe.com/docs/analytics/components/calculated-metrics/calcmetric-workflow/cm-build-metrics.html?lang=en#calculated-metrics) toevoegen:
...
1. Klik **[!UICONTROL Metrics > Add]** en voeg uw gegevensbronmetriek (klik, Inpressies, Totale Kosten) van de lijst van Standaard Metriek toe.
