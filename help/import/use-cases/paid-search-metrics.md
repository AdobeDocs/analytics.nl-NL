...
description: Stappen voor het configureren van Adobe Analytics voor het bijhouden van uw betaalde zoekresultaten (zoals Google AdWords, MSN, Yahoo, enz.) het gebruiken van Gegevensbronnen.
...
In de stappen wordt uitgelegd hoe u een eenmalige import van Pay-Per-Click-gegevens instelt. Het is echter [!UICONTROL Data Sources] mogelijk gegevens te blijven importeren in de bestandsindeling die hier wordt beschreven. Afhankelijk van uw betaalde zoekplatform kunt u mogelijk periodieke exportbewerkingen (dagelijks, maandelijks, enz.) plannen, geautomatiseerde processen instellen om deze exportbewerkingen om te zetten in de bestandsindeling die Adobe Analytics nodig heeft, en deze bestanden uploaden naar Adobe Analytics voor de rapportage van betaalde zoekintegratie.
...
[!UICONTROL Success events] zijn handelingen die kunnen worden bijgehouden. U bepaalt wat een [!UICONTROL success event] is. Voor onze doeleinden van het volgen van [!UICONTROL paid search] metriek, willen wij opstelling [!UICONTROL success events] rond [!UICONTROL clicks], [!UICONTROL impressions], [!UICONTROL total cost] en toelaten[!UICONTROL tracking codes].
...
1. Onder Gebeurtenissen van het Succes van de Douane, gebruik **[!UICONTROL Add New]** om 3 gebeurtenissen van het douanesucces tot stand te brengen: [!UICONTROL Clicks] (Teller), [!UICONTROL Impressions] (Teller) en [!UICONTROL Total Cost] (Valuta).
...
1. Schakel volgcodes in door het selectievakje naast **[!UICONTROL Tracking Code]** onder **[!UICONTROL Campaign > Campaign Variable]**.
...
1. Ga naar **[!UICONTROL Adobe Analytics > Admin > Data Sources]**.
1. Selecteer het **[!UICONTROL Create]** tabblad om nieuwe gegevensbronnen te activeren.
...
De [!UICONTROL Data Source Activation Wizard] weergave:

   ![Wizard Activering](assets/ds-activation-wizard.png)

1. Klik op de gegevensbron **[!UICONTROL Next]** en geef deze een naam. Deze naam wordt weergegeven in Data Source Manager.
1. Accepteer de serviceovereenkomst en klik op **[!UICONTROL Next]**.
1. Selecteer de drie standaardmetriek: [!UICONTROL Impressions]en [!UICONTROL Clicks] klik [!UICONTROL Total Cost] **[!UICONTROL Next]**.
1. Nu &quot;kaart&quot;deze nieuwe gegevensbron aan de douanegebeurtenissen die wij in [vormen de Gebeurtenissen](/help/admin/admin/c-success-events/t-success-events.md)van het Succes hebben gecreeerd.

   ![Toewijzing](assets/data-source-mapping.png)

1. Kies gegevensafmetingenSchakel het vakje naast Bijgehouden codes in en klik op **[!UICONTROL Next]**.
1. Dimension van kaartgegevens.
Wijs de geïmporteerde gegevensdimensie (kenmerk) toe aan het Adobe Analytics-kenmerk waarin u het wilt opslaan. Dit kan een standaardafmeting of een eVar zijn. Nadat u hebt geklikt, worden de resulterende toewijzingen weergegeven in het overzicht: **[!UICONTROL Next]**

   ![Samenvatting](assets/data-source-summary.png)

1. Klik op **[!UICONTROL Save]**.
1. Klik **[!UICONTROL Download]** om het sjabloonbestand voor deze gegevensbron te downloaden.
...
Stappen die vergelijkbaar zijn met deze bewerkingen voor Google Adwords, MSN, Yahoo en andere PPC-accounts.
...
1. Sla indien mogelijk het rapport op als een bestand `.csv` of als een bestand met tabs als scheidingsteken. Hierdoor wordt het gemakkelijker om met de volgende stappen te werken.
...
c. Controleer of Stap 1 van de wizard **[!UICONTROL Delimited]** is geselecteerd en klik op **[!UICONTROL Next]**.
d. Geef in Stap 2 van de wizard het scheidingsteken op, afhankelijk van de manier waarop u uw URL&#39;s hebt gemaakt (of ? of &amp;) en klik **[!UICONTROL Next]**.
...
U kunt bijvoorbeeld de volgende [berekende maatstaven](https://experienceleague.adobe.com/docs/analytics/components/calculated-metrics/calcmetric-workflow/cm-build-metrics.html?lang=en#calculated-metrics)toevoegen:
...
1. Klik en voeg uw gegevensbronmetriek (klik, Inpressies, Totale Kosten) van de lijst van Standaard Metriek toe **[!UICONTROL Metrics > Add]** en.
