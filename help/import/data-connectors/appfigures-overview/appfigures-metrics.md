---
description: De volgende metriek worden gesynchroniseerd als deel van de appFigures integratie.
...
De volgende metriek worden gesynchroniseerd als deel van de appFigures integratie.

| Metrisch | Beschrijving |
|---|---|
| Downloads App Store | Het aantal mobiele toepassingsdownloads. |
| Aankopen App Store (in app) | Het aantal aankopen in de app. |
| App Store Rank | Hiermee definieert u de berekende metrische gemiddelde appFigures. Niet rechtstreeks gebruikt. |
| Rank Divisor App Store | Hiermee definieert u de berekende metrische gemiddelde appFigures. Niet rechtstreeks gebruikt. |
| Classificatie App Store | Hiermee definieert u de berekende metrische gemiddelde appFigures. Niet rechtstreeks gebruikt. |
| Beoordelingsdivisie voor App Store | Hiermee definieert u de berekende metrische gemiddelde appFigures. Niet rechtstreeks gebruikt. |
| Opbrengsten van App Store (in app) | De hoeveelheid in app-inkomsten. |
| Opbrengst van App Store (één korting) | Het bedrag aan inkomsten dat aan de aankoop van een app is gekoppeld. |
| Royalty&#39;s voor App Store (in app) | Vervangen. |
| Royalty&#39;s App Store (één korting) | Vervangen. |

De volgende gereserveerde classificatiedimensies worden gecreeerd door de tovenaar van gegevensschakelaars voor identiteitskaart van het Voorwerp AppFigures gereserveerde Var.

| Classificatiedimensie | Beschrijving |
|---|---|
| Landnaam | De naam van het land dat is gerelateerd aan de activiteiten in de App Store. |
| Apparaatnaam | De naam van het mobiele apparaat die gerelateerd is aan de activiteit in de App Store. |
| Naam van toepassing | De naam van de appstore die de activiteit rapporteerde. |
| Toepassingsnaam | De naam van de mobiele toepassing. |
| Naam in toepassing | Het item dat in de toepassing is aangeschaft. |
| Categorienaam | Primaire categorie van de app in de App Store. |
| Revisietitel | Titel van de herziening. |
| Opmerking bekijken | Opmerking van de evaluatie |
| Toepassingsversie | Versie van de toepassing die is gebruikt om de revisie te genereren. |
| Gebruiker van App Store | Auteur (gebruikersnaam) van de revisie. |

De volgende berekende metrische waarde wordt gecreeerd door de tovenaar van gegevensschakelaars:

| Berekend metrisch | Beschrijving |
|--- |--- |
| Gemiddelde Rank App Store (numeriek) | De gemiddelde positie van apps. Deze berekende metrische waarde wordt gedefinieerd met behulp van de volgende formule:   `[App Store Rank]` / `[App Store Rank Divisor]`<br> Opmerking:  Het aantal toepassingen dat per categorie en land wordt gerangschikt, varieert per app-winkel. Als uw toepassing lager dan deze drempelwaarde wordt gerangschikt, zijn de rangschikkingen van de toepassing niet beschikbaar. |
| Gemiddelde beoordeling App Store | De gemiddelde score voor apps. Deze berekende metrische waarde wordt gedefinieerd met behulp van de volgende formule:  `[App Store Rating]` / `[App Store Rating Divisor]` |

## Relevante afmetingen voor Metrische AppFigures {#section-cd356d3dce04412893beed345305c247}

In de volgende tabel wordt aangegeven welke rapportafmetingen betrekking hebben op welke maatstaven.

<table id="table_B9CF57EABE22449FBF1963E3F105E702"> 
 <tbody> 
  <tr> 
   <td> </td> 
   <td> Downloads App Store </td> 
   <td> Aankopen App Store (in-app) </td> 
   <td> App Store Rank </td> 
   <td> Rank Divisor App Store </td> 
   <td> Classificatie App Store </td> 
   <td> Beoordelingsdivisie voor App Store </td> 
   <td> Opbrengsten van App Store (in-app) </td> 
   <td> Opbrengst van App Store (eenmalige) </td> 
   <td> Gem. App Store. Rang </td> 
   <td> Gem. App Store. Classificatie </td> 
  </tr> 
  <tr> 
   <td> Landnaam </td> 
  ...
  <tr> 
   <td> Naam van categorie openen </td> 
