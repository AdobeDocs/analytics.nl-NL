...
Nadat u de Event en eVars hebt geïdentificeerd om deze integratie te kunnen gebruiken, moeten ze zijn ingeschakeld in de Adobe Analytics Admin Console (zie [Report Suites](https://docs.adobe.com/content/help/en/analytics/admin/manage-report-suites/report-suites-admin.html) voor instructies).
