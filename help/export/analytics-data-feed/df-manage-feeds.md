...
# Gegevensfeeds beheren {#manage-data-feeds}
...
Zie ![ VideoCheckedOut ](/help/assets/icons/VideoCheckedOut.svg) [ het voederbeheer van Gegevens ](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/exporting/data-feeds/data-feeds-management-ui){target="_blank"} voor een demo video.
...
>title="Gegevensfeeds beheren"
>abstract="U kunt gegevensfeeds van deze pagina weergeven, maken en beheren. Zoek naar feeds op naam of identiteitskaart, of selecteer het filterpictogram om beschikbare filters te bekijken."
...
1. Gebruik zoekopdrachten of filters om een specifieke feed te zoeken.
   ...
   * Typ in het zoekveld de naam of id van een feed. Alleen de overeenkomende feeds worden weergegeven in de lijst met beschikbare feeds.
...
1. Selecteer het [!UICONTROL **lusje van Banen**] om individuele banen te bekijken die elk van uw voer leidt tot.

1. (Facultatief) om de baangeschiedenis voor specifieke gegevensvoer te bekijken, selecteer checkbox naast een gegevensvoer, dan de uitgezochte [!UICONTROL **geschiedenis van de Baan**].
...
1. Selecteer checkbox naast de gegevensvoer die u wilt kopiëren, dan selecteren [!UICONTROL **Exemplaar**].
   ...
   Dit neemt u om [ een nieuwe voer ](create-feed.md) met alle montages van de huidige voer tot stand te brengen. De optie om te kopiëren is niet zichtbaar als meer dan één gegevensvoer wordt geselecteerd.
...
Wanneer u een gegevensfeed verwijdert, wordt de status ingesteld op [!UICONTROL Deleted] . Gegevensfeeds moeten de status [!UICONTROL Active] hebben voordat ze kunnen worden verwijderd.
...
## Kolommen sorteren en aanpassen in de gegevensvoedermanager

Elke gegevensfeed bevat meerdere kolommen met informatie over de feed. U kunt informatie in elke kolom sorteren en de kolommen aanpassen die worden getoond.
...
1. Selecteer in het dialoogvenster Tabel aanpassen elke kolom die u wilt weergeven en hef de selectie van elke kolom op die u wilt verbergen.
   ...
   * **Bestemming**: De plaats het dossier wordt geplaatst.
   ...
   * **Laatste veranderde**: De datum het voer werd het laatst gewijzigd. Datum en tijd worden getoond in de de tijdzone van de rapportreeks met GMT compensatie.
   ...
   * **einddatum**: De datum van de laatste baan voor dit voer. Doorlopende gegevensfeeds hebben geen einddatum.
