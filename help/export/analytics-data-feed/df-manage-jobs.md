...
# Taken voor gegevensinvoer beheren {#manage-data-feed-jobs}
...
>title="Taakgeschiedenis gegevensfeed"
>abstract="U kunt een lijst weergeven met taken voor het doorvoeren van gegevens voor een bepaalde gegevensfeed van deze pagina. Zoek naar banen door identiteitskaart van het Verzoek of periode begint datum. De informatie over elke baan wordt getoond in de beschikbare kolommen. U kunt een taak ook opnieuw verzenden met dezelfde gegevens of de brongegevens van een taak opnieuw verwerken voordat u de taak opnieuw verzendt."
...
1. (Optioneel) In het zoekveld kunt u zoeken op basis van de aanvraag-id of de aanvraagperiode op de begindatum om de lijst met taken voor het doorvoeren van gegevens te doorzoeken.
