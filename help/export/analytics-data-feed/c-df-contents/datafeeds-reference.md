...
| | **`connection_type`** | Numerieke identiteitskaart die de [ afmeting vertegenwoordigt van het type van de Verbinding 0}. ](/help/components/dimensions/connection-type.md) Verwijst naar de opzoektabel van `connection_type.tsv` . | tinyint zonder teken |
...
| | **`hit_source`** | De bron waar de hit vandaan kwam. De bronnen 1 en 2 van de it worden gefactureerd. <br> 1: Standaard beeldverzoek zonder timestamp <br> 2: Standaard beeldverzoek met timestamp <br> 3: Levende gegevensbron uploadt met timestamps <br> 4: Niet gebruikt <br> 5: Algemene gegevensbron uploadt <br> 6: Niet meer gebruikt; het volledige uploaden van de verwerkingsgegevensbron <br> 7: De gegevensbron van TransactionID uploadt <br> 8: Niet meer gebruikt; Vorige versies van Adobe Advertising gegevensbronnen <br> 9} niet meer: gebruikt; Adobe Social summary metrics <br> : Audience Manager server-side het door:sturen gebruikt | tinyint zonder teken |
...
| **`post_`** | **`search_engine`** | Een numerieke id die staat voor het zoekprogramma waarmee de bezoeker naar uw site is doorverwezen. Gebruikt in [ afmetingen van de Motor van het 0} Onderzoek. ](/help/components/dimensions/search-engine.md) Verwijst naar de opzoektabel van `search_engines.tsv` . | small int zonder teken |
...
| **`post_`** | **`videonetwork`** | De [ het stromen media van het 0} Netwerk {dimensie.](/help/components/dimensions/sm-video-metadata.md) | varchar(255) |
| **`post_`** | **`videopath`** | De [ weg van Media ](/help/components/dimensions/sm-core.md) het stromen media de dienstendimensie. | varchar(100) |
| **`post_`** | **`videoplayername`** | De [ het stromen media de dienstendimensie van de speler van 0} Inhoud {.](/help/components/dimensions/sm-core.md) | varchar(255) |
...
| **`post_`** | **`videoqoeerrorcountevar`** | De [ het stromen media van de fouten ](/help/components/dimensions/sm-quality.md) dimensie van de Fouten {. | varchar(255) |
...
| **`post_`** | **`videosessionid`** | De [ het stromen media de dienstenafmeting van de zitting van Media 0}.](/help/components/dimensions/sm-core.md) | varchar(255) |
