...
| **`search_engine`** | Een numerieke ID die de zoekmachine vertegenwoordigt die de bezoeker naar uw site heeft verwezen. Gebruikt in ](/help/components/dimensions/search-engine.md) afmetingen van de Motor van het 0} Onderzoek. [ Verwijst naar de opzoektabel van `search_engines.tsv` . | small int zonder teken |
