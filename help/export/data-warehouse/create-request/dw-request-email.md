...
# Een e-mailbericht configureren voor een Data Warehouse-aanvraag
...
1. Vul de volgende velden in:
   ...
   | Optie | Functie |
   |---------|----------|
   | [!UICONTROL **verzendt bericht e-mail naar**] | Geef de e-mailadressen op van de personen die e-mailmeldingen moeten ontvangen wanneer het rapport wordt verzonden. <p>U kunt één e-mailadres of een door komma&#39;s gescheiden lijst met e-mailadressen opgeven.</p> |
...
1. Selecteer [!UICONTROL **sparen verzoek**] om het het rapportverzoek van Data Warehouse te bewaren.
