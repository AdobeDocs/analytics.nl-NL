---
description: Leer hoe u Data Warehouse-verzoeken weergeeft, dupliceert en opnieuw prioriteert.
title: Data Warehouse-verzoeken beheren
...
# Data Warehouse-verzoeken beheren

Je kunt Data Warehouse-aanvragen die je hebt gemaakt bekijken en beheren. Alleen beheerders kunnen aanvragen van andere gebruikers in hun organisatie weergeven en beheren.
...
1. (Optioneel) Klik op de naam van het verzoek om een dialoogvenster weer te geven met de volgende informatie: <!-- Check this -->
   ...
   * Rate Limited: Uw organisatie heeft te veel Data Warehouse-aanvragen uitgevoerd. Het verzoek wordt gepauzeerd tot andere gegevensverzoeken volledig zijn.
...
Je kunt de geschiedenis bekijken van Data Warehouse-verzoeken die je hebt gedaan.
...
1. Selecteer [!UICONTROL **de geschiedenis van de Mening**].
   ...
   | [!UICONTROL **identiteitskaart van het Rapport**] | De id die wordt gebruikt om een rapport in de huidige Data Warehouse-interface te identificeren. Deze id kan nodig zijn wanneer u contact opneemt met de klantenservice van Adobe. |
...
1. Selecteer [!UICONTROL **Exemplaar**].
   ...
   De Data Warehouse-aanvraagpagina voor kopiëren wordt weergegeven. Alle configuratieopties worden gekopieerd uit het oorspronkelijke verzoek.
...
1. Zorg ervoor dat alle kolommen die u wilt weergeven, zijn geselecteerd. Geselecteerde kolommen worden weergegeven op de Data Warehouse-pagina en geven de relevante informatie weer.
...
1. Geef in het zoekveld boven aan de Data Warehouse-pagina de naam op van de aanvraag die u wilt weergeven.
