...
| ----------- | ---------- | ---------- |
| **Bijwerken naar apparaatraadplegingen als gevolg van Google Client Hints** | 17 februari 2023 | **Het voor 16 februari 2023 geplande gebruik van de tips voor de klant is uitgesteld om de kwaliteit van de raadplegingen van het apparaat met behulp van de tips beter te waarborgen. Binnenkort wordt een nieuwe rollout-datum meegedeeld.** [Meer informatie](/help/technotes/client-hints.md) |
