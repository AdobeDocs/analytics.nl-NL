...
| ----------- | ---------- | ---------- |
| **Nieuw domein voor door het systeem gegenereerde e-mails** | 13 juli 2022 | Adobe heeft onlangs het domein van de afzender voor e-mails van de projecten van de Werkruimte, alarm, en overage alarm veranderd, van `noreply@omniture.com` tot `noreply@adobe.com`. Voeg deze nieuwe e-mail aan uw lijst van gewenste personen toe als uw organisatie slechts specifieke afzenders toestaat. |
