...
| **Data Warehouse-slechts afmetingen** | Op basis van feedback van klanten hebben we besloten om deze opnieuw te evalueren. De automatische functie alleen voor Data Warehouse wordt niet vrijgegeven zoals eerder aangekondigd. | | TBD |
