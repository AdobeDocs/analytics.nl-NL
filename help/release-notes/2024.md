...
| **de rekeningen en de plaatsen van het Aandeel die voor de uitvoer en de invoer** worden gebruikt | Gebruikers kunnen de accounts en locaties die ze maken nu beschikbaar maken voor alle gebruikers in hun organisatie. Alleen account- en locatie-eigenaars en systeembeheerders kunnen accounts en locaties bewerken en verwijderen.<p>Eerder konden accounts en locaties alleen worden gebruikt door de gebruiker die ze heeft gemaakt.</p><p>Deze montages zijn beschikbaar wanneer de gebruikers [ de invoer en de uitvoerrekeningen van de wolk vormen ](https://experienceleague.adobe.com/nl/docs/analytics/components/locations/configure-import-accounts) en [ de invoer en de uitvoerplaatsen van de wolk vormen ](https://experienceleague.adobe.com/nl/docs/analytics/components/locations/configure-import-locations). </p> | donderdag 12 juni 2024 | vrijdag 20 juni 2024 |
...
| **plaats `contextData` gebieden via XDM** | De klanten die gegevens verzenden naar Adobe Analytics via de Ervaring Edge Network kunnen [ de waarden van contextgegevens ](https://experienceleague.adobe.com/nl/docs/analytics/implementation/vars/page-vars/contextdata) direct of in XDM of in de &quot;gegevens&quot;gedeelten van de nuttige lading plaatsen. |  | Nu beschikbaar |
