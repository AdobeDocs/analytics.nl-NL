...
| **plaats `contextData` gebieden via XDM** | De klanten die gegevens verzenden naar Adobe Analytics via de Ervaring Edge Network kunnen [ de waarden van contextgegevens ](https://experienceleague.adobe.com/en/docs/analytics/implementation/vars/page-vars/contextdata) direct of in XDM of in de &quot;gegevens&quot;gedeelten van de nuttige lading plaatsen. |  | Nu beschikbaar |
