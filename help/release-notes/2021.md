...
Voor de meest recente updates over AppMeasurement-releases (versie 2.22.2) raadpleegt u [AppMeasurement voor JavaScript-releaseopmerkingen](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html).
...
Voor de meest recente updates over AppMeasurement-releases (versie 2.22.1) raadpleegt u [AppMeasurement voor JavaScript-releaseopmerkingen](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html).
