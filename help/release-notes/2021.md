...
| Bericht | Toegevoegd of bijgewerkt op | Beschrijving |
| ----------- | ---------- | ---------- |
| EOL van Adobe Data Connectors | woensdag 3 augustus 2021 | Adobe [!UICONTROL Data Connectors] worden mogelijk gemaakt door verouderde technologie die niet meer werkbaar is of ondersteund wordt. Een nieuwe norm is beschikbaar in het [ Programma van de Partner van de Adobe Exchange ](https://partners.adobe.com/exchangeprogram/experiencecloud). U kunt die standaard gebruiken om integratie te blijven aanbieden en ondersteunen. De officiële eind-van-levensdatum is **19 Augustus, 2021**. [Meer informatie...](https://experienceleague.adobe.com/nl/docs/discontinued/using/data-connectors) |
...
| EOL van Adobe Data Connectors | dinsdag 13 juli 2020 | Adobe [!UICONTROL Data Connectors] worden mogelijk gemaakt door verouderde technologie die niet meer werkbaar is of ondersteund wordt. Een nieuwe norm is beschikbaar in het [ Programma van de Partner van de Adobe Exchange ](https://partners.adobe.com/exchangeprogram/experiencecloud). U kunt die standaard gebruiken om integratie te blijven aanbieden en ondersteunen. De officiële einddatum is 1 augustus 2021. [Meer informatie...](https://experienceleague.adobe.com/nl/docs/discontinued/using/data-connectors) |
...
| EOL van Adobe Data Connectors | dinsdag 13 juli 2020 | Adobe [!UICONTROL Data Connectors] worden mogelijk gemaakt door verouderde technologie die niet meer werkbaar is of ondersteund wordt. Adobe heeft een nieuwe norm in het [ Programma van de Partner van de Adobe Exchange ](https://partners.adobe.com/exchangeprogram/experiencecloud) die voor om het even welke integratie zou moeten worden goedgekeurd die willen blijven worden aangeboden en gesteund. De officiële einddatum moet nog worden vastgesteld, maar de Adobe verwacht dat deze in de komende 12-18 maanden zal liggen (medio 2021 tot eind 2021). [Meer informatie...](https://experienceleague.adobe.com/nl/docs/discontinued/using/data-connectors) |
