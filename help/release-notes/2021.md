...
| Donker thema | [Donker thema](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/user-preferences.html#dark-theme) is beschikbaar als een weergaveoptie. | vrijdag 21 oktober 2021 |
...
| Bericht | Toegevoegd of bijgewerkt op | Beschrijving |
| ----------- | ---------- | ---------- |
| EOL voor drie Analytics API-services | vrijdag 16 september 2021 | Aan **28 oktober 2021** De volgende Analytics Legacy API-services zullen hun einddatum bereiken en worden afgesloten. De huidige integratie die met deze services wordt gebouwd, werkt niet meer op die dag.<ul><li>1.3 API&#39;s voor Analytics</li><li>1.4 API&#39;s voor SOAP Analytics</li><li>Verouderde OAuth-verificatie (OAuth en JWT)</li></ul>Adobe heeft een [Veelgestelde vragen over oudere API EOL](https://github.com/AdobeDocs/analytics-1.4-apis/blob/master/docs/APIEOL.md?mv=email) om u te helpen uw vragen te beantwoorden en hulp te bieden bij het volgen van verdere stappen. API-integraties die van deze services gebruikmaken, kunnen migreren naar de [1.4 Analytics REST-API&#39;s](https://github.com/AdobeDocs/analytics-1.4-apis?mv=email) of de [Analytics 2.0-API&#39;s](https://github.com/AdobeDocs/analytics-2.0-apis?mv=email). Oudere OAuth-accounts kunnen naar een [Adobe Developer](https://console.adobe.io/home?mv=email#) De rekening van de integratie van Analytics, die kan worden gebruikt om tot zowel 1.4 Analytics APIs als 2.0 Analytics APIs toegang te hebben. |
| EOL van Adobe [!UICONTROL Data Connectors] | dinsdag 3 augustus 2020 | Adobe [!UICONTROL Data Connectors] worden mogelijk gemaakt door verouderde technologie die niet meer werkbaar is of ondersteund wordt. Er is een nieuwe standaard beschikbaar in het dialoogvenster [Partnerprogramma voor Adobe Exchange](https://partners.adobe.com/exchangeprogram/experiencecloud). U kunt die standaard gebruiken om integratie te blijven aanbieden en ondersteunen. De officiële einddatum is **19 augustus 2021**. [Meer informatie...](https://experienceleague.adobe.com/en/docs/discontinued/using/data-connectors) |
| EOL van volledige verwerking [!UICONTROL Data Sources] | dinsdag 12 april 2021 | Adobe is vervangen door volledige gegevensbronnen voor verwerking **op 31 juli 2021**. Vanaf 25 maart 2021 kan er geen nieuwe invoer van dit type meer worden gecreëerd. Gebruik [API voor het invoegen van bulkgegevens](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/bdia.md) om dit type gegevens te importeren. |
...
| Bericht | Toegevoegd of bijgewerkt op | Beschrijving |
| ----------- | ---------- | ---------- |
| EOL van Adobe Data Connectors | dinsdag 3 augustus 2020 | Adobe [!UICONTROL Data Connectors] worden mogelijk gemaakt door verouderde technologie die niet meer werkbaar is of ondersteund wordt. Er is een nieuwe standaard beschikbaar in het dialoogvenster [Partnerprogramma voor Adobe Exchange](https://partners.adobe.com/exchangeprogram/experiencecloud). U kunt die standaard gebruiken om integratie te blijven aanbieden en ondersteunen. De officiële einddatum is **19 augustus 2021**. [Meer informatie...](https://experienceleague.adobe.com/en/docs/discontinued/using/data-connectors) |
| EOL voor drie Analytics API-services | vrijdag 15 juli 2021 | Aan **18 augustus 2021** De volgende Analytics Legacy API-services zullen hun einddatum bereiken en worden afgesloten. De huidige integratie die met deze services wordt gebouwd, werkt niet meer op die dag.<ul><li>1.3 API&#39;s voor Analytics</li><li>1.4 API&#39;s voor SOAP Analytics</li><li>Verouderde OAuth-verificatie (OAuth en JWT)</li></ul>Adobe heeft een [Veelgestelde vragen over oudere API EOL](https://github.com/AdobeDocs/analytics-1.4-apis/blob/master/docs/APIEOL.md?mv=email) om u te helpen uw vragen te beantwoorden en hulp te bieden bij het volgen van verdere stappen. API-integraties die van deze services gebruikmaken, kunnen migreren naar de [1.4 Analytics REST-API&#39;s](https://github.com/AdobeDocs/analytics-1.4-apis?mv=email) of de [Analytics 2.0-API&#39;s](https://github.com/AdobeDocs/analytics-2.0-apis?mv=email). Oudere OAuth-accounts kunnen naar een [Adobe Developer](https://console.adobe.io/home?mv=email#) De rekening van de integratie van Analytics, die kan worden gebruikt om tot zowel 1.4 Analytics APIs als 2.0 Analytics APIs toegang te hebben. |
| EOL van gegevensbronnen van volledige verwerking | dinsdag 12 april 2021 | Adobe is vervangen door volledige gegevensbronnen voor verwerking **op 31 juli 2021**. Vanaf 25 maart 2021 kan er geen nieuwe invoer van dit type meer worden gecreëerd. Gebruik [API voor het invoegen van bulkgegevens](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/bdia.md) om dit type gegevens te importeren. |
| Aanmelden voor update [!UICONTROL Report Builder] | zaterdag 9 april 2021 | Op 14 januari 2021 [!UICONTROL Report Builder] Sign-in updates verwijderde afhankelijkheden van verouderde technologieën en richtte het aanmeldingsproces op het Experience Cloud. Experience Cloud gebruikt uw Enterprise ID (e-mail en wachtwoord). Om ononderbroken toegang tot [!UICONTROL Report Builder], werkt u de [!UICONTROL Report Builder] invoegtoepassing in versie 5.6.47 of hoger **uiterlijk 22 juli 2021**. Report Builder versie 5.6.47 en hoger ondersteunt alleen het Experience Cloud aanmelden en biedt geen ondersteuning voor Single Sign-On. |
...
| Bericht | Toegevoegd of bijgewerkt op | Beschrijving |
| ----------- | ---------- | ---------- |
| EOL van Adobe Data Connectors | woensdag 3 augustus 2021 | Adobe [!UICONTROL Data Connectors] worden mogelijk gemaakt door verouderde technologie die niet meer werkbaar is of ondersteund wordt. Er is een nieuwe standaard beschikbaar in het dialoogvenster [Partnerprogramma voor Adobe Exchange](https://partners.adobe.com/exchangeprogram/experiencecloud). U kunt die standaard gebruiken om integratie te blijven aanbieden en ondersteunen. De officiële einddatum is **19 augustus 2021**. [Meer informatie...](https://experienceleague.adobe.com/en/docs/discontinued/using/data-connectors) |
| Einde van levensduur voor drie API-analysemogelijkheden | vrijdag 15 juli 2021 | Aan **18 augustus 2021** De volgende Analytics Legacy API-services zullen hun einddatum bereiken en worden afgesloten. De huidige integratie die met deze services wordt gebouwd, werkt niet meer op die dag.<ul><li>1.3 API&#39;s voor Analytics</li><li>1.4 API&#39;s voor SOAP Analytics</li><li>Verouderde OAuth-verificatie (OAuth en JWT)</li></ul>Adobe heeft een [Veelgestelde vragen over oudere API EOL](https://github.com/AdobeDocs/analytics-1.4-apis/blob/master/docs/APIEOL.md?mv=email) om u te helpen uw vragen te beantwoorden en hulp te bieden bij het volgen van verdere stappen. API-integraties die van deze services gebruikmaken, kunnen migreren naar de [1.4 Analytics REST-API&#39;s](https://github.com/AdobeDocs/analytics-1.4-apis?mv=email) of de [Analytics 2.0-API&#39;s](https://github.com/AdobeDocs/analytics-2.0-apis?mv=email). Oudere OAuth-accounts kunnen naar een [Adobe Developer](https://console.adobe.io/home?mv=email#) De rekening van de integratie van Analytics, die kan worden gebruikt om tot zowel 1.4 Analytics APIs als 2.0 Analytics APIs toegang te hebben. |
| EOL van gegevensbronnen van volledige verwerking | dinsdag 12 april 2021 | Adobe is van plan volledige verwerkingsgegevensbronnen te vervangen **op 31 juli 2021**. Vanaf 25 maart 2021 kan er geen nieuwe invoer van dit type meer worden gecreëerd. Gebruik [API voor het invoegen van bulkgegevens](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/bdia.md) om dit type gegevens te importeren. |
| Aanmelden voor update [!UICONTROL Report Builder] | zaterdag 9 april 2021 | Op 14 januari 2021 [!UICONTROL Report Builder] Sign-in updates verwijderde afhankelijkheden van verouderde technologieën en richtte het aanmeldingsproces op het Experience Cloud. Experience Cloud gebruikt uw Enterprise ID (e-mail en wachtwoord). Om ononderbroken toegang tot [!UICONTROL Report Builder], werkt u de [!UICONTROL Report Builder] invoegtoepassing in versie 5.6.47 of hoger **uiterlijk 22 juli 2021**. Report Builder versie 5.6.47 en hoger ondersteunt alleen het Experience Cloud aanmelden en biedt geen ondersteuning voor Single Sign-On. |
...
| Einde van levensduur voor drie API-analysemogelijkheden | donderdag 19 mei 2021 | Op 18 augustus 2021 bereikten de volgende Analytics Legacy API-services hun einddatum en werden ze afgesloten. Om het even welke huidige die integratie met deze diensten wordt gebouwd stopte werkend op die dag.<ul><li>1.3 API&#39;s voor Analytics</li><li>1.4 API&#39;s voor SOAP Analytics</li><li>Verouderde OAuth-verificatie (OAuth en JWT)</li></ul>Adobe heeft een [Veelgestelde vragen over oudere API EOL](https://github.com/AdobeDocs/analytics-1.4-apis/blob/master/docs/APIEOL.md?mv=email) om u te helpen uw vragen te beantwoorden en hulp te bieden bij het volgen van verdere stappen. API-integraties die van deze services gebruikmaken, kunnen migreren naar de [1.4 Analytics REST-API&#39;s](https://github.com/AdobeDocs/analytics-1.4-apis?mv=email) of de [Analytics 2.0-API&#39;s](https://github.com/AdobeDocs/analytics-2.0-apis?mv=email). Oudere OAuth-accounts kunnen naar een [Adobe Developer](https://console.adobe.io/home?mv=email#) De rekening van de integratie van Analytics, die kan worden gebruikt om tot zowel 1.4 Analytics APIs als 2.0 Analytics APIs toegang te hebben. |
...
| EOL van gegevensbronnen van volledige verwerking | dinsdag 12 april 2021 | De Adobe is van plan de volledige gegevensbronnen voor de verwerking op 31 juli 2021 af te schaffen. Vanaf 25 maart 2021 kan er geen nieuwe invoer van dit type meer worden gecreëerd. Gebruik [API voor het invoegen van bulkgegevens](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/bdia.md) om dit type gegevens te importeren. |
| Aanmelden voor update [!UICONTROL Report Builder] | zaterdag 9 april 2021 | Op 14 januari 2021 [!UICONTROL Report Builder] Sign-in updates verwijderde afhankelijkheden van verouderde technologieën en richtte het aanmeldingsproces op het Experience Cloud. Experience Cloud gebruikt uw Enterprise ID (e-mail en wachtwoord). Om ononderbroken toegang tot [!UICONTROL Report Builder], werkt u de [!UICONTROL Report Builder] uiterlijk op 22 juli 2021 aan versie 5.6.47 of hoger toe te voegen. Report Builder versie 5.6.47 en hoger ondersteunt alleen het Experience Cloud aanmelden en biedt geen ondersteuning voor Single Sign-On. |
...
| EOL van Adobe Data Connectors | dinsdag 13 juli 2020 | Adobe [!UICONTROL Data Connectors] worden mogelijk gemaakt door verouderde technologie die niet meer werkbaar is of ondersteund wordt. Er is een nieuwe standaard beschikbaar in het dialoogvenster [Partnerprogramma voor Adobe Exchange](https://partners.adobe.com/exchangeprogram/experiencecloud). U kunt die standaard gebruiken om integratie te blijven aanbieden en ondersteunen. De officiële einddatum is 1 augustus 2021. [Meer informatie...](https://experienceleague.adobe.com/en/docs/discontinued/using/data-connectors) |
...
| Data Warehouse API-aanvragen ondersteunen nu &quot;Uren&quot; | vrijdag 20 mei 2021 | Data Warehouse API vraagt supportdatums in de `Y-m-d h:m:s` formatteren wanneer de parameter `"fuzzyDates":false` wordt verstrekt in de verzoekende instantie. Met deze update kunt u gegevens van Data Warehouse aanvragen voor de huidige dag, terwijl eerder de dag moet worden voltooid voordat gegevens worden geretourneerd. [Meer informatie](https://github.com/AdobeDocs/analytics-1.4-apis/blob/master/docs/reporting-api/data_warehouse.md) |
...
| [!UICONTROL Usage Log] API | vrijdag 25 maart 2021 | Dit is een nieuwe v2.0 Analytics API die programmatic toegang tot de zelfde gegevens van het gebruikslogboek toelaat beschikbaar onder **[!UICONTROL Admin]** > **[!UICONTROL Log]** > **[!UICONTROL Usage and Access Log]**. Er zijn aanvullende details beschikbaar over verificatie, schema en voorbeeldreactie [hier](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/usage-logs.md). |
...
| Bericht | Toegevoegd of bijgewerkt op | Beschrijving |
| ----------- | ---------- | ---------- |
| EOL van [!UICONTROL Full Processing] [!UICONTROL Data Sources] | 12 april 2021, 2021 | Adobe is van plan af te schaffen [!UICONTROL Full Processing] [!UICONTROL Data Sources] op 31 juli 2021. Vanaf 25 maart 2021 kan er geen nieuwe invoer van dit type meer worden gecreëerd. Gebruiken [API voor het invoegen van bulkgegevens](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/bdia.md) om dit type gegevens te importeren. [Meer informatie](https://experienceleague.adobe.com/docs/analytics/import/data-sources/data-types-and-categories/datasrc-fullproc-eol.html) |
| Aanmelden voor update [!UICONTROL Report Builder] | zaterdag 9 april 2021 | In januari 2021 [!UICONTROL Report Builder] Sign-in updates verwijderde afhankelijkheden van verouderde technologieën en richtte het aanmeldingsproces op het Experience Cloud. Experience Cloud gebruikt uw Enterprise ID (e-mail en wachtwoord). Om ononderbroken toegang tot [!UICONTROL Report Builder], werkt u de [!UICONTROL Report Builder] uiterlijk op 22 juli 2021 aan versie 5.6.47 of hoger toe te voegen. Report Builder versie 5.6.47 en hoger biedt alleen ondersteuning voor het aanmelden bij het Experience Cloud en biedt geen ondersteuning voor Single Sign-On. |
...
| Kennisgeving van aanstaande wijzigingen in het menu Analytics | donderdag 24 maart 2021 | Op 22 april 2021 zullen we de **[!UICONTROL Components]**, **[!UICONTROL Tools]**, en **[!UICONTROL Admin]** vervolgkeuzemenu&#39;s om de prestaties enigszins te verbeteren. Al deze pagina&#39;s zijn nog steeds beschikbaar onder de **[!UICONTROL All Components]**, **[!UICONTROL All Tools]**, en **[!UICONTROL All Admin]** koppelingen - deze worden gewoon verwijderd uit het keuzemenu. Hier volgen de menu-items die uit het keuzemenu worden verwijderd en op de respectievelijke koppelingspagina worden geplaatst:<br><br> [!UICONTROL Components]<ul><li>[!UICONTROL Bookmarks]</li><li>[!UICONTROL Dashboards]</li><li>[!UICONTROL Targets]</li><li>[!UICONTROL Calendar Events]</li><li>[!UICONTROL Scheduled Reports]</li><li>[!UICONTROL Report Settings]</li></ul>[!UICONTROL Tools]<ul><li>[!UICONTROL Recommendations Classic]</li><li>[!UICONTROL Search & Promote]</li></ul>[!UICONTROL Admin]<ul><li>[!UICONTROL User Management]</li><li>[!UICONTROL Classification Importer]</li><li>[!UICONTROL Classification Rule Builder]</li><li>[!UICONTROL Data Sources]</li><li>[!UICONTROL Data Connectors]</li><li>[!UICONTROL Company Settings]</li><li>[!UICONTROL Logs]</li><li>[!UICONTROL Dynamic Tag Management]</li><li>[!UICONTROL Code Manager]</li><li>[!UICONTROL Exclude by IP]</li><li>[!UICONTROL Traffic Management]</li></ul> |
| [!UICONTROL Same-as-SiteCatalyst VISTA Processing] = ON | donderdag 17 maart 2021 | Op 17 juni 2021 zullen alle rapportagekassen worden bijgewerkt om [!UICONTROL Same-as-SiteCatalyst VISTA Processing] ingesteld op ON. Deze wijziging heeft gevolgen [!UICONTROL Data Warehouse] rapportage door de gegevens te verwerken overeenkomstig de verwerkingsregels. Raadpleeg de Adobe van de klantenservice voor vragen of verduidelijkingen. |
...
| Taalselectie van analytische dashboards | vrijdag 14 januari 2021 | Navigeren naar **[!UICONTROL Settings]** > **[!UICONTROL Preferences]** > **[!UICONTROL Language]** om een taal te selecteren in het dashboard Analytics. |
...
| ----------- | ---------- | ------- |
| Analysis Workspace - Componentselectie | vrijdag 4 februari 2021 | De component drop-down/drop zone gevonden in [!UICONTROL Quick Insights] is toegevoegd aan alle dropzones in [!UICONTROL Workspace]. Dankzij deze verbetering kunt u kiezen uit een vervolgkeuzelijst met compatibele componenten of de ruimte blijven gebruiken als een neerzetzone. |
| Analysis Workspace - URL&#39;s voor afbeeldingen | vrijdag 14 januari 2021 | U kunt afbeeldingen toevoegen aan [!UICONTROL Workspace] projecten door naar een openbare beeld-URL te verwijzen. |
...
| EOL van Adobe Data Connectors | dinsdag 13 juli 2020 | Adobe [!UICONTROL Data Connectors] worden mogelijk gemaakt door verouderde technologie die niet meer werkbaar is of ondersteund wordt. Adobe heeft een nieuwe norm in [Partnerprogramma voor Adobe Exchange](https://partners.adobe.com/exchangeprogram/experiencecloud) dat moet worden aangenomen voor alle integraties die aangeboden en ondersteund willen blijven worden. De officiële einddatum moet nog worden vastgesteld, maar de Adobe verwacht dat deze in de komende 12-18 maanden zal liggen (medio 2021 tot eind 2021). [Meer informatie...](https://experienceleague.adobe.com/en/docs/discontinued/using/data-connectors) |
