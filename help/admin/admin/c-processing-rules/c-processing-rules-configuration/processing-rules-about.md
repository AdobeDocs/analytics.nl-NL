...
<table id="table_287C606AE26E47AA8F737411990ACEB2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Wijzigingen in de verwerkingsregels moeten binnen minuten na opslaan zichtbaar zijn in de rapportsuite. Wanneer het testen van verwerkingsregels, adviseren wij vormend <a href="/help/admin/admin/realtime/t-realtime-admin.md"> real-time rapporten</a> in uw reeks van het testrapport zodat kunt u de resultaten van een verwerkingsregel snel zien. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> <a href="/help/admin/admin/c-processing-rules/processing-rules-examples/processing-rules-copy-context-data.md"> Kopieer een variabelen voor contextgegevens naar een eVar </a> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>De variabele van de contextgegevens wordt bijvoorbeeld <code> login_page-home</code> automatisch <code> login_pagehome</code>. Alle gegevens die naar de <code> login_page-home</code> variabele worden verzonden, worden toegewezen onder <code> login_pagehome</code>. </p> <p>Contextgegevensvariabelen die niet-ondersteunde tekens bevatten, kunnen niet worden toegevoegd aan de interface Verwerkingsregels. </p> </td> 
  </tr> 
  <tr> 
...
U kunt bijvoorbeeld twee variabelen `category:product` samenvoegen om deze weer te geven.
