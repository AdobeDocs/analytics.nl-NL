...
* Vergelijkt het gebruik van uw huidige periode tot het gebruik van vorig jaar (blauwe lijn). Duidelijk, zal de blauwe lijn slechts verschijnen als uw bedrijf de gegevens van het het vraaggebruik van de server van het vorige jaar heeft.
  ...
  >[!NOTE]
  >
  >Als u het gebruik van een vorige periode wilt bekijken, moet u naar [Gebruik van rapportsuite](/help/admin/admin/c-server-call-usage/report-suite-usage.md) en downloadt u de gebruiksgegevens voor een vorige periode.
...
| UI-term | Definitie |
| --- | --- |
| Huidig tijdverbruik (groen) | De huidige periode is gebaseerd op de [gebruiksperiode](/help/admin/admin/c-server-call-usage/overage-overview.md). |
