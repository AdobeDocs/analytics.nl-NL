...
Met de pagina [!UICONTROL Classification Hierarchies] kunt u classificatiehiërarchieën definiëren waarmee u [!UICONTROL Hierarchy]-rapporten met dezelfde naam kunt maken.

Met een [!UICONTROL Hierarchy]-rapport kunt u naar meer verfijnde gegevenssets gaan op basis van de classificatiehiërarchie, zodat u gegevensrelaties eenvoudiger kunt bekijken.
...
Maak de classificaties voordat u ze aan een hiërarchie toevoegt.
...
1. Selecteer in de vervolgkeuzelijst **[!UICONTROL Build Hierarchy For]** de variabele op de plaats waar u een classificatiehiërarchie wilt maken.
