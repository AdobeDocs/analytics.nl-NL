...
| [!UICONTROL Status]  (alleen eVar) | Definieert de status [!UICONTROL eVar]:<ul><li>**Uitgeschakeld**: Hiermee schakelt u het  [!UICONTROL eVar]uit. Hiermee verwijdert u [!UICONTROL eVar] uit de lijst met conversievariabelen.</li><li>**Geen subrelaties**: Hiermee voorkomt u dat u het  [!UICONTROL eVar] door een dimensie splitst.</li><li>**Basissubrelaties**: Hiermee kunt u een eVar afsplitsen op een volledige afmeting (bijvoorbeeld Producten of Campagne).</li></ul> |
