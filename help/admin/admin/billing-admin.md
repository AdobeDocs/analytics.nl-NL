...
>[!NOTE]
>
>Om een werkend exemplaar van het [!UICONTROL Monthly Invoice] rapport te verkrijgen, kopieer het op uw klembord, dan kleef het in een spreadsheetprogramma zoals Microsoft Excel*.
