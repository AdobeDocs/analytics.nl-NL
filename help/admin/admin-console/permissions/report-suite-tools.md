...
|------|------|
| Data Warehouse | Niet gebruikt. Gebruik in plaats hiervan &#39;Custom Data Warehouse Report&#39;. |
| Site Catalyst | Niet gebruikt. Gebruik in plaats hiervan Toegang tot analysewerkruimte. |
| Rapportsets (lezen) | Niet gebruikt. |
| Rapportsets (schrijven) | Niet gebruikt. |
| Verkeersbeheer | Niet gebruikt. |
...
| Video-instellingen | Niet gebruikt. |
...
| Methoden zoeken | Hiermee krijgt u toegang tot Conversie > Methoden zoeken in Report Suite Manager. |
...
| Rapport voor aangepaste gegevensopslagruimte | Hiermee krijgt u toegang tot Gereedschappen > Data Warehouse in de bovenste navigatie Analytics. |
...
| Verouderde ClickMap | Niet gebruikt. Gebruik in plaats hiervan Activiteitenkaart onder Analytics Tools. |
...
| KPI/Gage ReportLet | Niet gebruikt. |
| Totalen van rapportsuite | Niet gebruikt. |
| Tekstrapport | Niet gebruikt. |
