...
Nadat u hebt gemigreerd, kunt u [Experience Cloud-gebruikers en -producten beheren](https://experienceleague.adobe.com/docs/core-services/interface/manage-users-and-products/admin-getting-started.html) in de Adobe Admin Console.
...
<table id="table_36FD7EF1DAB44D359F4FC186D93147E5"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe stelt Analytische beheerders via e-mail op de hoogte met instructies over het begin van de migratie. </p> <p>Migraties naar de Adobe Admin Console vinden plaats in golven. Op de dag van migratie, brengt Adobe de beheerders van Analytics op de hoogte en verleent hen toegang tot het migratiehulpmiddel. Nadat een login bedrijf aan de criteria voldoet die voor elke migratiegolf worden bepaald, zal Adobe: </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Voordat u de migratie start, kunt u gebruikers maken in de Adobe Admin Console of in Analytics &gt; User Management. </p> <p>Nadat de migratie is begonnen, kunt u alleen gebruikers en machtigingsgroepen maken in de Adobe Admin Console. </p><p>Zie de sectie Migratie hieronder voor meer informatie over wat er gebeurt op de startdatum van de migratie. </p>
   </td> 
  </tr> 
  <tr> 
...
<table id="table_0E37BB1DEA6143F0B5F4E861FCFA7189"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Hoe worden machtigingsgroepen gerepliceerd naar de Adobe Admin Console? En mijn gebruikers? </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </ul> <p>Deze blijven beschikbaar in Analytics-gebruikersbeheer. </p> <p>Zie <a href="/help/admin/admin-console/user-management2/user-migration/c-migration-tool.md"> Niet-ondersteunde analysefuncties in de Adobe Admin Console</a> voor meer informatie . </p> </td> 
  </tr> 
  <tr> 
