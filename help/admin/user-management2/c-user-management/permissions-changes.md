...
<table id="table_D1DB0DE37752450BBCCA44DB760BB505"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <span class="uicontrol"> Nieuwe groep</span> <span class="uicontrol"> toevoegen &gt; Toegang rapporteren</span> </p> <p>De sectie <span class="wintitle"> Rapporttoegang</span> op de pagina <span class="wintitle"> Gebruikersgroep</span> definiëren is gestroomlijnd naar vier categorieën, waarmee u machtigingen op korrelig niveau kunt aanpassen. </p> <p><img  src="assets/report-access.png" id="image_CB83E5C7DB4343619421A1FAA61478D0"> </img> </p> <p>Items eerder in </p> 
    <ul id="ul_16D5EF18D57D4608AEEDEC40D90D8828"> 
     <li id="li_F29E84C6228A464C8807F09205AEAAC6"> <p> <a href="/help/admin/user-management2/c-customize-report-access/groups-analytics-tools.md"> Analytics-gereedschappen</a>: Laat gebruikerstoestemmingen voor Algemene punten (het factureren, logboeken, enz.), het Beheer van het Bedrijf, Hulpmiddelen, de Toegang van de Dienst van het Web, de Bouwer van het Rapport, en de integratie van de Verbindingen van Gegevens toe. </p> <p> <b>Opmerking:</b> De bedrijfsinstellingen van de categorie Admin Console aanpassen zijn verplaatst naar Analytics Tools. </p> </li> 
    ...
    </ul> <p>U kunt bijvoorbeeld een groep maken met toegang tot meerdere Analytics-gereedschappen (<span class="wintitle"> Analysis Workspace</span>, <span class="wintitle"> Reports &amp; Analytics</span>en <span class="wintitle"> Report Builder</span>), met toestemming voor specifieke metriek en dimensies (inclusief eVars) en mogelijkheden zoals het maken van segmenten of berekende metriek. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Wijzigingen in vooraf gedefinieerde groepen </p> </td> 
   <td colname="col2"> <p> <b>Beheerderstoegang:</b> Voor beheerders zijn vooraf gedefinieerde groepen niet meer vereist. De beheerders hebben nu toegang tot alle punten (hulpmiddelen, metriek, dimensies), evenals de toegang van de Dienst van het Web, de Bouwer van het Rapport, Activity Map, en Ad hoc analysis. </p> <p>Het doel van groepen is om niet-administratieve gebruikers toegang te verlenen of te beperken. </p> <p> <b>Aangepaste groepen:</b> Aangepaste groepen hebben vooraf gedefinieerde groepen vervangen. Bestaande, vooraf gedefinieerde groepen worden gemigreerd naar aangepaste groepen met dezelfde groepsnaam. Alle aangepaste groepen die u hebt gemaakt, inclusief de instellingen, blijven behouden. U zult echter zien dat de locatie van de instellingen is verplaatst. De bedrijfsinstellingen (in Admin Console Aanpassen) bevinden zich nu in <a href="/help/admin/user-management2/c-customize-report-access/groups-analytics-tools.md"> Analytics-gereedschappen</a>aanpassen. </p> <p> De gebruikers die tot <span class="term"> Al Toegang</span> van het Rapport behoren zijn gemigreerd aan een douanegroep met toegang tot: </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Wordt alleen aanbevolen voor nieuwe klanten of klanten met bedrijven die <a href="https://docs.adobe.com/content/help/en/core-services/interface/about-core-services/core-services.html"> provisioning uitvoeren in de Experience Cloud</a>. Er is een migratie gepland voor bestaande <span class="keyword"> Analytics</span> -klanten naar het <span class="keyword"> Experience Cloud</span> -systeem voor identiteitsbeheer. </p> <p>Meer informatie vindt u in de Admin Console <a href="https://helpx.adobe.com/enterprise/using/manage-permissions-and-roles.html"></a>onder Productmachtigingen beheren. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_1E93F45C66E841E6882FB602509F30A3"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Moet ik de Admin Console gebruiken om gebruikers te beheren, of het bestaande Gebruikersbeheer van Analytics? </p> </td> 
   <td colname="col2"> <p>Wijzigingen in Analytics &gt; Beheer &gt; Gebruikersbeheer worden niet in de Admin Console weergegeven. Daarom zouden slechts nieuwe klanten die reeds de Admin Console voor gebruiker en groepsbeheer gebruiken dit moeten blijven doen. Er is een migratie gepland naar de Admin Console van het bestaande Analytics-groepsbeheer. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nee, alle machtigingen voor migraties worden transparant uitgevoerd. </p> <p> 
     <ul id="ul_654F85286EC04416B3E0BA725EBE10AD"> 
      ...
      <li id="li_2FCD9254FC3C4FD7871EEF9453E5CE1E">Voor elke aangepaste groep met maateenheden worden alle Analytics Solution-gebeurtenissen toegevoegd als nieuwe maateenheden. </li> 
...
<table id="table_B68FD00FC5D24823A86BB69558C0327C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Admin Console - Voor Experience Cloud-gebruikers </p> <p>Hulpmiddelen Admin - voor alle gebruikers, maar voor gebruikers van Experience Cloud, schrapt slechts de in kaart gebrachte gebruiker van Analytics, niet de rekening van Experience Cloud. </p> </td> 
   <td colname="col3"> <p>Admin Console - voor gemigreerde gebruikers. </p> <p>Beheertools - alleen voor Analytics-gebruikers. </p> </td> 
   <td colname="col4"> <p>Admin Console </p> <p> Hulpprogramma's voor beheerders - Nadat u een Experience Cloud-gebruiker hebt verwijderd of de koppeling met zijn account in de Admin Console hebt opgeheven, kunt u de Analytics-aanmelding verwijderen via de beheerprogramma's. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Aanmelden bij Analytics </td> 
   <td colname="col2"> <p> <b>Experience Cloud: </b> <span class="filepath"> marketing.adobe.com</span>. Alleen beschikbaar voor Experience Cloud-gebruikers. </p> <p> <b>Analytics (verouderd):</b> <span class="filepath"> sc.omniture.com</span>. Alleen voor Analytics-gebruikers en voor Experience Cloud-gebruikers met hun Analytics-gebruikersgegevens </p> </td> 
   <td colname="col3"> <p> <span class="filepath"> marketing.adobe.com</span> - alleen beschikbaar voor Experience Cloud-gebruikers. </p> <p> <span class="filepath"> sc.omniture.com</span> - Alleen voor analytische gebruikers en voor Experience Cloud-gebruikers met hun Analytics-gebruikersgegevens. </p> <p>Tijdens de migratie kunnen beheerders de aanmeldmogelijkheden voor <span class="filepath"> omniture.com</span> voor specifieke gebruikers uitschakelen. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Admin Console (<a href="https://docs.adobe.com/content/help/nl-NL/core-services/interface/manage-users-and-products/admin-getting-started.html"> productconfiguratie</a>maken) </p> </td> 
   <td colname="col4"> <p>Admin Console (<a href="https://docs.adobe.com/content/help/nl-NL/core-services/interface/manage-users-and-products/admin-getting-started.html"> productconfiguratie</a>maken) </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Gebruikers in een groep bewerken </td> 
   <td colname="col2"> <p>Admin Console - Alleen voor Experience Cloud-gebruikers </p> <p>Hulpmiddelen Admin - zowel gebruikers Analytics-slechts, als het gebruikerslidmaatschap van Experience Cloud aan groepen kunnen van Hulpmiddelen Admin worden uitgegeven. Als een Experience Cloud-gebruiker echter deel uitmaakt van een groep in de Admin Console, kunnen deze gebruikers niet uit de groep worden verwijderd in de beheerprogramma's. </p> </td> 
   <td colname="col3"> <p>Admin Console - alleen Experience Cloud-gebruikers </p> <p> Hulpmiddelen Admin - het slechts Analytics-Logins kunnen nog aan/uit groepen in Hulpmiddelen worden toegevoegd Admin. </p> </td> 
   <td colname="col4"> <p>Admin Console </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Admin Console - Alleen voor Experience Cloud-gebruikers. </p> <p>Beheertools - Alleen voor Analytics-gebruikers. </p> </td> 
   <td colname="col4"> <p>Admin Console </p> </td> 
  </tr> 
 </tbody> 
</table>
