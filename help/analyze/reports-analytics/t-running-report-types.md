...
In Analysis Workspace kunt u een groot aantal verschillende typen rapporten uitvoeren. Hieronder volgen enkele voorbeelden.

Voor een volledige lijst van beschikbare pre-gebouwde rapporttypes, zie [Vooraf samengestelde rapporten gebruiken](/help/analyze/analysis-workspace/reports/use-reports.md)
...
De [!UICONTROL Fallout Report] toont het aantal bezoekers dat een vooraf bepaalde reeks pagina&#39;s heeft bezocht. Het toont ook omzettings en valutarieven tussen elke stap.

Bekijk de nieuwe [Falloutanalyse](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/visualizations/fallout/fallout-flow.html) in Analysis Workspace!

1. In [!UICONTROL Adobe Analytics], klikt u op **[!UICONTROL Reports]** > **[!UICONTROL Paths]** > **[!UICONTROL Pages]** > **[!UICONTROL Fallout]**.
1. Op de [!UICONTROL Fallout Report] pagina, klikt u **[!UICONTROL Launch the Fallout Report Builder]**.

1. Op de [!UICONTROL Define Checkpoints] , geeft u de controlepunten op die u voor het rapport wilt gebruiken.
1. Klik op **[!UICONTROL Run Report]**.

## Een paginastroom-rapport uitvoeren {#task_133E8B87C3F04DA0A42D10CBA499305B}

In de rapporten Paginastroom wordt de volgorde weergegeven waarin bezoekers de pagina&#39;s openen en door uw site navigeren. Dit rapport helpt een antwoord

Klik bijvoorbeeld op **[!UICONTROL Workspace]** > **[!UICONTROL Reports]** > **[!UICONTROL Engagement]** > **[!UICONTROL Next and previous page flow]**.
...
Zie de [Marketingkanaal](/help/components/c-marketing-channels/analyze-mc.md) Help-systeem voor meer informatie.

## Een Anomaly Detection-rapport uitvoeren {#task_4808C96327354D789C075823F5C3A049}

U kunt [Analyse van anomaly-detectie en -bijdrage](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/virtual-analyst/anomaly-detection/anomaly-detection.html) alleen in Analysis Workspace.
...
Zie [Overzicht van real-time rapportage](/help/components/c-real-time-reporting/realtime.md) voor meer informatie .

1. Kijk eens naar de **[!UICONTROL Overview]** verslag en de onderdelen ervan:  ![](assets/rtr_overview_report.png)
   ...
   <td class="chdesc stentry"> Toont de rapportreeks die dit rapport in real time behandelt. Als u de rapportsuite wilt wijzigen, raadpleegt u <a href="https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/real-time-reports/t-realtime-admin.html"  > Configuratie van realtime rapporten </a>. </td> 
   </tr> 
   <tr class="chrow strow"> 
   ...
   <td class="chdesc stentry"> Het pictogram van de volledige-schermmening is zichtbaar slechts als uw monitor een specifieke aspectverhouding (of 16:9 of 16:10) heeft EN als uw browser het steunt. Let op: u kunt niet communiceren met het scherm terwijl het in de modus Volledig scherm wordt weergegeven (druk op <span class="uicontrol"> Esc </span> om af te sluiten). De modus Volledig scherm heeft geen time-out. </td> 
   </tr> 
   <tr class="chrow strow"> 
   ...
   <td class="chdesc stentry"> Stelt een telling van het Totaal van de Plaats voor metrisch in real time rapport voor de laatste N minuten voor. "N"is configureerbaar door de selecteur van de Waaier van de Tijd. <p>De pijlkleur en -richting zijn gebaseerd op het volgende algoritme: 
      ...
      <li id="li_234ECBD7D83A4AE680E4A70BF288681F"> Verlies (pijl-omlaag): tussen -5% en -100% </li> 
...
2. Klik op een lijstitem in het primaire rapport om het dialoogvenster **[!UICONTROL Details]** weergave voor dat lijstitem:  ![](assets/rtr_detail_report.png)
