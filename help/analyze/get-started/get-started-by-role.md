...
De [implementatiemethode](https://experienceleague.adobe.com/docs/analytics/implementation/home.html?lang=nl-NL) die u kiest, bepaalt het type gegevens dat kan worden verzameld.
...
Zie [Adobe Analytics](https://experienceleague.adobe.com/docs/analytics/implementation/home.html?lang=nl-NL) implementeren voor meer informatie over elke beschikbare methode.
...
|---------|----------|---------|
| Beheerdersrollen definiëren | Adobe Analytics ondersteunt verschillende soorten beheerders | [Beheerdersrollen in Adobe Analytics](https://experienceleague.adobe.com/docs/analytics/admin/admin-console/admin-roles-in-analytics.html?lang=nl-NL) |
...
| Stel rapportsuites in en definieer instellingen voor uw bedrijf | Een rapportenreeks is een silo van gegevens die Adobe Analytics gebruikt om rapporten te produceren.<p>Beheerders kunnen ook virtuele rapportsuites[&#128279;](https://experienceleague.adobe.com/docs/analytics/components/virtual-report-suites/vrs-about.html?lang=nl-NL) instellen om gegevens verder te segmenteren.</p> | <ul><li>[Een rapportsuite maken](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/manage-report-suites/c-new-report-suite/t-create-a-report-suite.html?lang=nl-NL)</li><li>[Overzicht bedrijfsinstellingen](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/company-settings/c-company-settings.html?lang=nl-NL)</li></ul> |
| Gegevens importeren | Met Adobe Analytics-gegevensbronnen kunt u aanvullende online of offline gegevens importeren voor rapportage. | [Overzicht van gegevensbronnen](https://experienceleague.adobe.com/docs/analytics/import/data-sources/overview.html?lang=nl-NL) |
| Gegevens classificeren met classificaties | Met classificaties kunt u gegevens classificeren om beter gebruik te maken van variabelen, zodat u meer inhoud in één variabele kunt opnemen. | [Overzicht van classificaties](https://experienceleague.adobe.com/docs/analytics/components/classifications/c-classifications.html?lang=nl-NL) |
...
| Logbestanden | Logbestanden om u te helpen zien wanneer gebruikers zich aanmelden, hun gebruik, toegang, rapportsuites en beheerderswijzigingen. | [Logboeken](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/logs.html?lang=nl-NL) |
...
| Gegevens exporteren | Met datawarehouse en datafeeds kunt u gegevens exporteren naar verschillende cloudbestemmingen, zoals Google Cloud Platform, Azure RBAC, Azure SAS en Amazon S3. | [Exportgids voor Analytics](https://experienceleague.adobe.com/docs/analytics/export/home.html?lang=nl-NL) |
