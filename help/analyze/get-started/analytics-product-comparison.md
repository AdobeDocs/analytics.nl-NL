...
| **Veelvoudige rapportsuites** | [ ja ](/help/analyze/analysis-workspace/build-workspace-project/multiple-report-suites.md) | Ja | Nee | Ja | Nee |
...
| **de bestemmingen van de Levering** | E-mail | E-mail, FTP, SFTP, [ het publiceren aan Microsoft PowerBI ](/help/analyze/legacy-report-builder/c-publish-power-bi/power-bi.md) | Amazon S3, Google Cloud Platform, Azure SAS, Azure RBAC en e-mail | Amazon S3, Azure RBAC, Azure SAS en Google Cloud Platform | - |
...
| **Geo en technologierapporten** | Ja <p>Hiermee gebruikt u gemiddelde waarden in plaats van postvelden. De logica voor het eerst zoeken is gebaseerd op `post_cust_hit_time_gmt` in plaats van op `visit_page_num=1` . De resultaten zouden van andere hulpmiddelen kunnen verschillen als IP veranderingen midden-bezoek, klappen uit-van-orde aankomen, of bezoeken over maandgrenzen heen.</p> | Ja <p>Hiermee gebruikt u gemiddelde waarden in plaats van postvelden. De logica voor het eerst zoeken is gebaseerd op `post_cust_hit_time_gmt` in plaats van op `visit_page_num=1` . De resultaten zouden van andere hulpmiddelen kunnen verschillen als IP veranderingen midden-bezoek, klappen uit-van-orde aankomen, of bezoeken over maandgrenzen heen.</p> | Ja <p>Gebruikt postwaarden en `visit_page_num=1` om de eerste treffer van het bezoek te bepalen. Hiermee past u de waarde van de eerste hit toe op alle treffers in het bezoek voor deze afmetingen.</p> | Ja <p>Gebruikt postwaarden en `visit_page_num=1` om de eerste treffer van het bezoek te bepalen. Hiermee past u de waarde van de eerste hit toe op alle treffers in het bezoek voor deze afmetingen.</p> | Ja <p>Hiermee gebruikt u gemiddelde waarden in plaats van postvelden. De logica voor het eerst zoeken is gebaseerd op `post_cust_hit_time_gmt` in plaats van op `visit_page_num=1` . De resultaten zouden van andere hulpmiddelen kunnen verschillen als IP veranderingen midden-bezoek, klappen uit-van-orde aankomen, of bezoeken over maandgrenzen heen.</p> |
