...
2. Selecteer om het even welke volgende producteigenschappen om het te vormen:
   ...
   | Webservices | De API&#39;s van de webservices bieden programmatische toegang tot marketingrapporten en andere suiteservices waarmee u beschikbare functionaliteit in de Analytics-interface kunt dupliceren en uitbreiden. | [&#128279;](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/company-settings/web-services-admin.html) de diensten van 0&rbrace; Web |
   | Report Builder-rapporten | Licentie beheren die is toegewezen aan Report Builder-gebruikers. | [Report Builder-rapporten](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/company-settings/report-builder-reports-admin.html) |
