...
* **Bedekking**: Adobe biedt een browser uitbreiding aan om de gegevens van Activity Map in de context van uw website te bekijken. Deze functie is niet beschikbaar voor SDK-implementaties op het web.
...
Uw implementatie moet correct zijn geconfigureerd om Activity Map-gegevens naar Adobe te verzenden. De extensie van de overlaybrowser is niet beschikbaar wanneer Adobe Analytics wordt geïmplementeerd met de webbrowser SDK.
