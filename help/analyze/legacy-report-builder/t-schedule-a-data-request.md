...
1. Klik op **[!UICONTROL Schedule]** op de werkbalk van Report Builder.
...
| Power BI | Zie [ Publish Werkboek aan Microsoft Power BI ](/help/analyze/legacy-report-builder/c-publish-power-bi/integration-power-bi.md) voor meer informatie. |
...
| Publiceren naar Power BI | <ul><li>Werkboek publiceren naar Power BI</li><li>Alle Report Builder-verzoeken publiceren als Power BI-gegevenssets</li><li>Alle opgemaakte tabellen publiceren als Power BI-gegevenssets</li></ul> |
| Dit Power BI-rapport labelen als | Etiketteringsdetails |

1. Klik op **[!UICONTROL OK]** en vervolgens op **[!UICONTROL Exit]** .

   Report Builder toont het geplande werkboek in de [ Geplande Manager van de Taak ](/help/analyze/legacy-report-builder/r-arb-scheduled-reports.md).
