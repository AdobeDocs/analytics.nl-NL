...
Nadat u zich bij Adobe Experience Cloud en Analytics hebt aangemeld, schakelt u de schakelknop [!UICONTROL New landing page - Beta] linksonder in. De toegang tot de knevelknoop is user-specific per organisatie, niet bedrijfspecifiek.
...
* Menu Analyse boven: De meeste rapporten staan nu in het menu [!UICONTROL Reports] in de linkerspoorstaaf.
...
| Pictogram Vastzetten | U kunt punten vastzetten en zij *altijd* verschijnen bij de bovenkant van uw lijst. |
...
![Tabblad Rapporten](assets/reports-tab.png)
