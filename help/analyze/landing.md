---
description: Verklaart hoe de landingspagina zowel Analysis Workspace als Rapporten & Analytics in één enkele interface en toegangspunt onder de paraplu van Workspace samenbrengt.
...
De Adobe Analytics-landingspagina bevat de volgende subtabs:

**[!UICONTROL Projects]**: Aangepaste ontwerpen die gegevenscomponenten, tabellen en visualisaties combineren die u hebt gemaakt of die iemand anders met u heeft gemaakt en gedeeld. [!UICONTROL Projects] verwijst ook naar lege projecten en lege mobiele scorecards.
...
**[!UICONTROL Learning]**: bevat praktische videorondes, zelfstudies en koppelingen naar documentatie.

![&#x200B; A het landen pagina verlaten spoorstaaf &#x200B;](assets/aa-landing-page-left-rail.png)

>[!BEGINSHADEBOX]

Zie ![&#x200B; VideoCheckedOut &#x200B;](/help/assets/icons/VideoCheckedOut.svg) [&#x200B; Adobe Analytics landende pagina &#x200B;](https://experienceleague.adobe.com/nl/docs/analytics-learn/tutorials/analysis-workspace/analysis-workspace-basics/navigating-the-new-landing-page){target="_blank"} voor een demo video.

>[!ENDSHADEBOX]

## Projecten {#navigate-projects}

De **[!UICONTROL Projects]** sectie in het linkerspoor dient als homepage voor [!UICONTROL **Workspace**] tabel.

Toegang krijgen tot projecten in Adobe Analytics:

1. Selecteer het [!UICONTROL **Workspace**] lusje.

1. Selecteer [!UICONTROL **Projecten**] in het linkerspoor.

De sectie van Projecten toont de omslag van het Bedrijf, om het even welke persoonlijke omslagen u creeerde, uw projecten van Workspace, en Mobiele scorecards. Met deze pagina kunt u mappen, projecten en mobiele scorecards weergeven, maken en wijzigen. Zie [&#x200B; Projecten &#x200B;](/help/analyze/analysis-workspace/build-workspace-project/freeform-overview.md) voor meer informatie.
...
>[!NOTE]
>
>Verschillende van de volgende instellingen blijven in meerdere sessies behouden. Bijvoorbeeld het tabblad dat u hebt geselecteerd, de geselecteerde segmenten, de geselecteerde kolommen en de sorteerrichting van de kolom. Zoekresultaten blijven niet behouden.

Zie [&#x200B; Projecten &#x200B;](/help/analyze/analysis-workspace/build-workspace-project/freeform-overview.md) voor meer informatie.
...
## Sjablonen {#navigate-reports}

Ga als volgt te werk om sjablonen te openen in Adobe Analytics:

1. Selecteer het [!UICONTROL **Workspace**] lusje.

1. In de [!UICONTROL **sectie van Malplaatjes**] in het linkerspoor, kunt u of de malplaatjes van Adobe of bedrijfmalplaatjes selecteren.

Zie de volgende bronnen voor informatie over het gebruik van sjablonen:
...
1. In Adobe Analytics, uitgezochte [!UICONTROL **Workspace**] > [!UICONTROL **Lerend**].
...
1. In Adobe Analytics selecteert [!UICONTROL **Componenten**] > [!UICONTROL **Voorkeur**] > [!UICONTROL **Algemeen**].
1. Selecteer de gewenste bestemmingspagina.
...
| Vraag | Antwoord |
| --- | --- |
| Waar zijn de sjablonen die ik in [!UICONTROL Workspace] ken? | Deze sjablonen worden gegroepeerd onder de tab [!UICONTROL Templates] . |
