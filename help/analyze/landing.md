...
![Tabblad Rapporten](assets/reports-tab2.png)


### Rapporten weergeven {#menus}

1. Ga naar de [!UICONTROL **Rapporten**] tab.
1. Gebruik het onderzoeksgebied aan onderzoek naar een specifiek rapport.

   of

   Navigeer naar het rapport dat u wilt weergeven.
...
### Een rapport weergeven en opslaan {#use-reports}
...
1. Voer een van de volgende handelingen uit:
   ...
   * Voeg afsplitsingen toe, sleep in andere metriek, en pas over het algemeen het rapport aan uw behoeften aan.

1. (Optioneel) Sla het rapport op als een project door [!UICONTROL **Project**] > [!UICONTROL **Opslaan**].

   Hiermee slaat u het verslag op als een nieuw project; het wijzigt het bestaande verslag niet . Voor meer informatie over het bewaren van een rapport als project, zie &quot;een project van een leeg project of een rapport&quot;tot stand brengen in [Projecten maken](/help/analyze/analysis-workspace/build-workspace-project/create-projects.md).
