 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>A: Grafieken en grafieken worden in Workspace 'visualisaties' genoemd. </p> 
    <ul id="ul_597F5AB826EF434295D0CABD0313CAD5"> 
     ...
     <li id="li_D5C7EA8815344EDB8585CBB8E1AF583E"><b>Cirkeldiagram</b>: Geëxporteerd als een  <a href="https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/visualizations/donut.html"  > </a> Donutvisualisatie. Deze visualisatie in Workspace is beperkt tot 19 secties. </li> 
     <li id="li_91659FBFD77C4B3393D78447D658B7B4"><b>Bubbeldiagram</b>: Geëxporteerd als een  <a href="https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/visualizations/scatterplot.html"  > </a> verstrooiing. Standaard tekent het beelddiagram de eerste metrische waarde op de x-as en de tweede metrische waarde op de y-as. Als er slechts één metrische waarde is, zullen de borstelgrafieken in de visualisaties van de Lijn worden omgezet. </li> 
     <li id="li_FA05085FFB1747EBAF63616AC2B8D59C"><b>Histogram</b>: Biedt ondersteuning voor een andere emaillogica in Workspace dan in Ad Hoc Analysis. Daarom wordt het omgezet in <a href="https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/visualizations/bar.html"  > Bar</a> visualisatie. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </ul> <p>U kunt segmenten in <a href="https://docs.adobe.com/content/help/en/analytics/components/segmentation/seg-home.html"  > de Bouwer van het Segment uitgeven</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><b>V: Hoe worden datumbereiken geconverteerd?</b> </p> </td> 
   <td colname="col2"> 
    <ul id="ul_A24AB597F3CE4847AF00D49A9A72A395"> 
     <li id="li_24FD18AF64114445939C4FBC03F2D406">De datumbereiken 'Laatste X dag' in Ad Hoc Analysis <i>exclude</i> vandaag, terwijl Analysis Workspace <i>include</i> vandaag is. Datumbereiken als 'Laatste 90 dagen' komen dus mogelijk niet precies overeen tussen de gereedschappen. Pas in plaats daarvan 'Last X <b>full </b> days'-bereiken toe in Analysis Workspace. </li> 
    ...
    </ul> <p>U kunt uw waaiers van de douanedatum uitgeven onder <span class="uicontrol"> Analytics</span> &gt; <span class="uicontrol"> Componenten</span> &gt; <span class="uicontrol"> de Waaier van de Datum</span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><b>V: Hoe worden berekende metriek omgezet?</b> </p> </td> 
   <td colname="col2"> 
    <ul id="ul_ADA380D5D09B4223AAE4853D4C64F679"> 
     <li id="li_010572F793F54680ABE64117DAB7E800">De berekende metriek zijn intern aan het uitgevoerde project (niet openbaar). U kunt verkiezen om hen openbaar te maken, door metrisch met de rechtermuisknop aan te klikken en <span class="uicontrol"> maken Openbaar </span> te klikken. <p><img placement="inline"  src="assets/calc_metric_internal.png" id="image_EA19BA55B161499CBDB9275A5C94BA90" width="200px" /> </p> </li> 
    ...
    </ul> <p>U kunt het toewijzingstype in <a href="https://docs.adobe.com/content/help/nl-NL/analytics/components/calculated-metrics/cm-overview.html"  > Berekende Metrische Bouwer uitgeven </a> door het uitgeven (potlood) pictogram te klikken. </p> </td> 
  </tr> 
  <tr> 
