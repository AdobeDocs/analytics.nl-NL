...
Met Report Builder for Adobe Analytics kunt u:
...
Report Builder for Adobe Analytics is een Microsoft Excel-invoegtoepassing. De add-in is beschikbaar op de volgende platforms:
...
>[!IMPORTANT]
>
>In deze overzichtsvideo ziet u de Report Builder-gebruikersinterface in Customer Journey Analytics. Sommige gebruikersinterface en terminologie verschillen wanneer u de Report Builder in Adobe Analytics gebruikt. Anders is de gebruikerservaring identiek.
