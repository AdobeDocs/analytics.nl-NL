...
In Report Builder is verificatie vereist om data-aanvragen te maken op basis van uw rapportsuites. Soms zijn er problemen bij het aanmelden bij de Report Builder afhankelijk van uw instellingen binnen [!DNL Analytics] of uw netwerk.
...
* **U moet eerst de [!UICONTROL Request Wizard] afsluiten voordat u [!UICONTROL Request Manager] activeert.**: Terwijl de [!UICONTROL Request Manager] en de [!UICONTROL Request Wizard] zijn functioneel gekoppeld, is het niet mogelijk te beginnen met werken met de [!UICONTROL Request Manager] voordat de in de [!UICONTROL Request Wizard].
