...
Bovendien, nadat u een werkboekprogramma in de Bouwer van het Rapport creeert, kunt u het programma in **[!UICONTROL Analytics]** > **[!UICONTROL Reports]** bekijken en uitgeven. (Zie [Plan en distributie](/help/analyze/reports-analytics/scheduling.md) rapporteren in Rapporten &amp; Analytics Help.)
