...
| Standaardmenustructuur van Adobe tonen | Negeert de montages in de Hulpmiddelen Admin, waar de beheerders rapportmenu&#39;s aanpassen om gebruikersvoorkeur te passen, terugkerend het rapportmenu aan standaardmontages. |
...
| Kalendergebeurtenissen opnemen in rapporten | Traceert de prestaties van de site ten opzichte van specifieke gebeurtenissen. Als deze optie is ingeschakeld, worden deze gebeurtenissen in uw rapporten weergegeven. |
| Flash gebruiken | Hiermee schakelt u grafieken van Flash in uw rapporten in. Flash grafieken bieden scherpere, interactieve afbeeldingen voor rapporten, maar u kunt de afbeeldingen niet gemakkelijk kopiëren of opslaan. Schakel deze optie uit voor het snel kopiëren of opslaan van afbeeldingen (de afbeeldingen hebben de .gif-indeling). Als u deze optie uitschakelt, wordt de knop voor de kopieergrafiek niet weergegeven op de werkbalk van het rapport. |
| Gegevens &quot;Alle overige&quot; weergeven in geselecteerde grafieken | Hiermee worden alle andere objecten onder de bovenste vijf gegroepeerd in één object weergegeven. (In staafdiagrammen worden de bovenste vijf webpagina&#39;s of andere gegevens in uw rapport weergegeven.) |
| Gegevens &quot;Geen&quot;, &quot;Niet opgegeven&quot; en &quot;Getypte/bladwijzergegevens&quot; tonen in rapportgrafieken | Toont metriek waar geen waarde krediet voor gespecificeerde metrisch werd ontvangen. |
