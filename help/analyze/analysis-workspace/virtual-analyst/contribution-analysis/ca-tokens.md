...
# Overzicht van de bijdrageanalyse
...
>[!IMPORTANT]
>
>De analyse van de bijdrage is verwijderd uit de de eigenschapreeks van Rapporten &amp; van Analyse en is nu beschikbaar slechts via de Werkruimte van de Analyse.

Alle klanten met een machtiging voor de bijdrageanalyse kunnen de volledige bijdrageanalyse een beperkt aantal keren per maand uitvoeren in de analysewerkruimte. Dit **sluit** klanten van het puntproduct (SiteCatalyst 15), klanten van de Stichting van Analytics, en Analytics Uitgezochte klanten uit, die helemaal geen Analyse van de Bijdrage krijgen.

Het aantal uitvoeringen per bedrijf wordt beperkt door maandelijkse tokens die worden toegekend op basis van het Adobe Analytics-product dat uw bedrijf heeft aangeschaft. Dit omvat de capaciteit om de toegang van de Analyse van de Bijdrage te beperken om symbolisch misbruik te vermijden.
...
<table id="table_357775E5058644099E26B15A6790E8AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Standaard hebben alleen beheerders toegang om Contribute-analyses uit te voeren, maar beheerders kunnen andere gebruikers toegang geven door een machtigingengroep te maken in de <a href="https://docs.adobe.com/content/help/en/core-services/interface/manage-users-and-products/admin-getting-started.html"  > beheerconsole </a>. U zou toestemming moeten geven om de Analyse van de Bijdrage slechts aan gebruikers te gebruiken die een wettige reden hebben om het te gebruiken en worden vertrouwd om hun toegang niet te misbruiken. </p> <p>De toestemming wordt genoemd "Analyse van de Bijdrage"onder <span class="ignoretag"><span class="uicontrol"> Analytics</span> &gt; <span class="uicontrol"> Admin</span> &gt; <span class="uicontrol"> Gebruikersbeheer</span> &gt; <span class="uicontrol"> geeft Groepen</span> uit &gt; <span class="uicontrol"> geeft Alle Toegang</span> <span class="uicontrol"></span> <span class="uicontrol"></span></span>van het Rapport uit &gt;  de Hulpmiddelen van de Reeks van het Rapport aan &gt; Hulpmiddelen en Rapporten. </p> </td> 
  </tr> 
  <tr> 
...
Hieronder vindt u een lijst met de gedetailleerde rechten voor analyse van de Anomaly Detection and Contribution Analysis in Analysis Workspace.

>[!IMPORTANT]
>
>Analyse van de Anomaly Detection and Contribution is verwijderd uit de set met functies Rapporten &amp; Analytics en is nu alleen beschikbaar via de Analyse Workspace. Klanten van Adobe Analytics Select en Adobe Analytics Foundation hebben alleen toegang tot Anomaly Detection in Workspace.
