...
U kunt Analysis Workspace-projecten delen met mensen die geen toegang hebben tot Adobe Analytics. Dit kan het volgende omvatten:
...
>[!NOTE]
>
>Deze optie kan worden uitgeschakeld door de beheerder van Analytics, zoals wordt beschreven in [Voorkeuren](/help/analyze/analysis-workspace/user-preferences.md). Als u geen openbare verbinding kunt delen zoals die in deze sectie wordt beschreven, heeft uw beheerder Analytics deze capaciteit onbruikbaar gemaakt.
