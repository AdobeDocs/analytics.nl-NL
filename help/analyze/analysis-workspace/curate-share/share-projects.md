...
* Beheerders die in het dialoogvenster **[!UICONTROL Edit copy]** of **[!UICONTROL Read only]** de rol krijgt die beperkte ervaring wanneer zij een project openen . Een beheerder kan zijn rol wijzigen in **[!UICONTROL Edit original]** door het project met elkaar te delen en de **Bewerken** rol, zoals beschreven in de volgende procedure.
...
1. Selecteer in Adobe Analytics de optie [!UICONTROL **Werkruimte**] tab, dan selecteren [!UICONTROL **Projecten**] in het linkerspoor.
...
1. Selecteren **[!UICONTROL Share]**. (Als het project al is gedeeld, selecteert u [!UICONTROL **Bijwerken**].)
   ...
   Selecteren **[!UICONTROL Curate and Share]** om automatisch projectcuratie toe te passen. (Als het project al is gedeeld, selecteert u **[!UICONTROL Curate & Update]**.) Meer informatie over [projectcursus](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/curate-share/curate.html).
...
1. Geef op of u de volgende beveiligingsoptie wilt inschakelen (deze optie kan worden beheerd door de beheerder van Analytics):
   ...
   * **[!UICONTROL Require Experience Cloud authentication]:**
      ...
      * Als deze optie is ingeschakeld en gedimd, vereist de beheerder van Analytics verificatie van het Experience Cloud voor iedereen die Analysis Workspace-projecten opent.
...
Wanneer iemand een project met u deelt door [delen van een specifieke projectrol](#share-a-specific-project-role), kunt u de gedeelde projecten openen vanuit de [Het tabblad Projecten van de landingspagina Analytics](/help/analyze/landing.md#navigate-the-projects-tab).

Wanneer iemand een project met u deelt door een koppeling te delen (van de [Tabblad Project delen](#share-a-link-to-a-project) of met een [delen met iedereen](#share-a-project-with-anyone-no-login-required) (koppeling), moet u de koppeling gebruiken die met u is gedeeld om toegang te krijgen tot het project. De koppeling kan bijvoorbeeld zijn gedeeld in een e-mail, op een interne website, enzovoort.
