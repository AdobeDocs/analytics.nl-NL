...
<table id="table_7A2E678577F94BDABB1276C826E6554F">
 ...
 <tbody>
  <tr>
   <td colname="col1"> <p>Meer<a href="/help/analyze/analysis-workspace/visualizations/freeform-table/filter-and-sort.md"  > filteropties </a> voor dimensie-items in vrije-vormtabellen </p> </td>
...
<table id="table_892279F2B4AF4DB38C64AA9AFC5657A7">
 ...
 <tbody>
  ...
  <tr>
   <td colname="col1"> <p> <a href="/help/analyze/analysis-workspace/visualizations/t-sync-visualization.md"  > Gekoppelde visualisaties die worden vermeld in de instellingen voor de databron </a> </p> </td>
...
<table id="table_2649645FDED84B71952F741ABB3FC20E">
 ...
 <tbody>
  <tr>
   ...
   <td colname="col2"> <p>Verzend een Analysis Workspace-project via e-mail, of plan het voor levering. Zie <a href="/help/analyze/analysis-workspace/curate-share/t-schedule-report.md"  > Bestand verzenden - Een project plannen voor levering</a>. </p> </td>
  </tr>
  <tr>
   <td colname="col1"> PDF downloaden </td>
   <td colname="col2"> <p>Vanuit het menu Handeling kunt u een Analysis Workspace-project in de PDF-indeling downloaden (vergelijkbaar met downloaden in de CSV-indeling). </p> </td>
  </tr>
 </tbody>
</table>
...
<table id="table_4285E6982FBD4B66AC95AAF6C5C7B347">
 ...
 <tbody>
  <tr>
   ...
   <td colname="col2"> <p> Hiermee worden de volgende kleuren toegepast op cellen, op basis van datawaarden worden: </p>
    ...
    </ul> <p>Als u een dimensie in de tabel vervangt, worden de limieten voor voorwaardelijke opmaak opnieuw ingesteld. Wanneer u een metric vervangt, worden de limieten voor die kolom opnieuw berekend (waarbij de metric op de X-as staat en de dimensie op de Y-as). </p> </td>
  </tr>
  <tr>
   <td colname="col1"> Automatisch genereren </td>
   <td colname="col2"> <p>Hiermee worden de limieten voor voorwaardelijke opmaak automatisch gegenereerd. De bovengrens is de hoogste waarde in deze kolom. De ondergrens is de laagste en het middelpunt is het gemiddelde van de boven- en ondergrens. </p> </td>
  </tr>
  <tr>
   <td colname="col1"> Aangepast </td>
   <td colname="col2"> <p>U kunt de waarden voor de velden <span class="uicontrol">Boven</span>, <span class="uicontrol">Middelpunt </span>en <span class="uicontrol">Ondergrens</span> handmatig toewijzen voor voorwaardelijke opmaak. Dit biedt u de flexibiliteit om te bepalen wanneer een kolomwaarde goed, gemiddeld, of slecht wordt. </p> </td>
  </tr>
 </tbody>
</table>
