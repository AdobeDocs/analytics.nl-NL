...
1. Ga in Adobe Analytics naar de [!UICONTROL **Project**] openingspagina, en selecteer vervolgens [!UICONTROL **Voorkeuren**].
...
U kunt algemene voorkeuren aanpassen voor alle nieuwe projecten die u in Analysis Workspace maakt. Voor informatie over hoe u deze voorkeuren kunt openen, raadpleegt u [Voorkeuren bijwerken](#update-preferences).
...
Sommige van deze voorkeuren kunnen ook voor afzonderlijke projecten worden aangepast, zoals wordt beschreven in [Overzicht van project](/help/analyze/analysis-workspace/build-workspace-project/freeform-overview.md).
...
|  | Annotaties tonen | Kies of annotaties zichtbaar zijn in uw projecten. Zie voor meer informatie over annotaties [Overzicht van annotaties](/help/analyze/analysis-workspace/components/annotations/overview.md). |
...
|  | Achtergrond | Hiermee wordt bepaald of alle celopmaak in een cel wordt weergegeven of verborgen, inclusief de staafgrafiek en voorwaardelijke opmaak <ul><li>Staafgrafiek</li> Hiermee wordt een horizontale staafgrafiek weergegeven die de waarde van de cel ten opzichte van het totaal voor de kolom vertegenwoordigt. <li>Voorwaardelijke opmaak</li>Zie Voorwaardelijke opmaak in voor meer informatie over voorwaardelijke opmaak [Kolominstellingen](/help/analyze/analysis-workspace/visualizations/freeform-table/column-row-settings/column-settings.md)</ul> |
...
|  | Uitsplitsing naar positie | Selecteer deze optie als u wilt dat de uitsplitsing bij de positie van het item blijft en niet bij het item zelf. Voor meer informatie over uitsplitsingen raadpleegt u [Afmetingen onderverdelingen](/help/analyze/analysis-workspace/components/dimensions/t-breakdown-fa.md). |
...
| **[Combografieken](/help/analyze/analysis-workspace/visualizations/combo-charts.md)** |  |  |
...
| **[Hoofdmetrische samenvatting](/help/analyze/analysis-workspace/visualizations/key-metric.md)** |  |  |
...
|  | 100% gestapeld | Met deze instelling op een gestapeld gebied, gestapelde staaf of horizontale staaf verandert u het diagram in een &#39;100% gestapelde&#39; visualisatie. <p>Zie voor meer informatie [Stapel en balk gestapeld](/help/analyze/analysis-workspace/visualizations/bar.md).</p> |
| **[Histogram](/help/analyze/analysis-workspace/visualizations/histogram.md)** |  |  |
|  | Aantal emmers | Kies het aantal gegevensbereiken (emmers) in de visualisatie. Het maximumaantal emmers is 50. <p>Zie voor meer informatie [Histogram](/help/analyze/analysis-workspace/visualizations/histogram.md).</p> |
...
| **[Samenvattingswijziging](/help/analyze/analysis-workspace/visualizations/summary-number-change.md)** |  |  |
...
| **[Samenvattingsnummer](/help/analyze/analysis-workspace/visualizations/summary-number-change.md)** |  |  |
...
|  | Alle openbare toegangskoppelingen uitschakelen | <p>Hiermee voorkomt u dat gebruikers in uw organisatie Analysis Workspace-projecten delen met personen die geen Analysis Workspace-account hebben. Gebruikers kunnen projecten alleen delen met andere Analysis Workspace-gebruikers binnen uw organisatie.</p> <p>Wanneer openbare koppelingen zijn uitgeschakeld:</p> <ul><li><p>Gebruikers kunnen geen koppelingen voor openbare toegang maken</p><p>De optie Openbare koppeling delen is verwijderd uit het menu Delen. Dit betekent dat gebruikers geen projecten meer kunnen delen met personen die geen Analysis Workspace-account in uw organisatie hebben zoals beschreven in [Een openbare koppeling delen met iedereen (geen aanmelding vereist)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Projecten delen](/help/analyze/analysis-workspace/curate-share/share-projects.md).</p></li> <li><p>Bestaande openbare koppelingen zijn uitgeschakeld</p></li><p>Als openbare koppelingen zijn uitgeschakeld en vervolgens opnieuw worden ingeschakeld, worden niet alle eerder gedeactiveerde koppelingen automatisch opnieuw geactiveerd. In dit geval moeten gebruikers de bestanden voor elk project handmatig opnieuw activeren in het dialoogvenster Project delen.</p> |
|  | Wachtwoord vereisen | <p>Hiermee dwingt u gebruikers in uw organisatie wachtwoordbeveiliging te vereisen wanneer zij openbare koppelingen maken.</p> <p>Wanneer deze optie is ingeschakeld en een gebruiker een openbare koppeling naar een Analysis Workspace-project maakt, wordt de optie Wachtwoord vereisen ingeschakeld in het dialoogvenster Delen en kan deze optie niet door de gebruiker worden uitgeschakeld. (Voor informatie over hoe de gebruikers projecten met gebruikers buiten de organisatie kunnen delen, zie [Een openbare koppeling delen met iedereen (geen aanmelding vereist)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Projecten delen](/help/analyze/analysis-workspace/curate-share/share-projects.md).)</p><p>Houd rekening met het volgende wanneer u deze optie inschakelt:</p> <ul><li><p>Wanneer u deze optie inschakelt, worden alle momenteel actieve openbare koppelingen waarvoor wachtwoordbeveiliging niet is ingeschakeld, gedeactiveerd.</p></li> <li><p>Als deze optie is ingeschakeld en later wordt uitgeschakeld, worden niet alle eerder gedeactiveerde koppelingen automatisch opnieuw geactiveerd. In dat geval moeten gebruikers de bestanden handmatig opnieuw activeren vanuit het dialoogvenster Project delen.</p></li></ul> |
|  | Single Sign-On verificatie vereisen | <p>Vereist Single Sign-On (SSO) authentificatie voor alle openbare verbindingen. Wanneer deze optie is ingeschakeld, hebben alleen ontvangers met een gefedereerde id en kunnen zich aanmelden bij Experience Cloud toegang tot gedeelde openbare koppelingen.</p> <p>Wanneer deze optie is ingeschakeld en een gebruiker een koppeling naar een Analysis Workspace-project maakt, wordt de optie &quot;Single Sign-On (SSO)-verificatie vereisen&quot; ingeschakeld in het dialoogvenster Delen en kan deze optie niet door de gebruiker worden uitgeschakeld. (Voor informatie over hoe de gebruikers projecten met gebruikers buiten de organisatie kunnen delen, zie [Een openbare koppeling delen met iedereen (geen aanmelding vereist)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Projecten delen](/help/analyze/analysis-workspace/curate-share/share-projects.md).)</p> <p>Houd rekening met het volgende wanneer u deze optie inschakelt:</p><ul><li><p>Wanneer u deze optie inschakelt, worden alle actieve openbare koppelingen waarvoor SSO niet is ingeschakeld, gedeactiveerd.</p></li> <li><p>Als deze optie is ingeschakeld en later wordt uitgeschakeld, worden niet alle eerder gedeactiveerde koppelingen automatisch opnieuw geactiveerd. In dat geval moeten gebruikers de bestanden handmatig opnieuw activeren vanuit het dialoogvenster Project delen.</p></li> <li><p>Deze optie is alleen beschikbaar als SSO in uw organisatie is geïmplementeerd. Voor informatie over hoe de systeembeheerders SSO voor uw organisatie kunnen toelaten, zie [Identiteit instellen en Single Sign-On](https://helpx.adobe.com/enterprise/using/set-up-identity.html){target=_blank}.</p><p>Als SSO voor uw organisatie wordt gevormd, controleer om te zien of wordt om het even welk soort auto-rekening verwezenlijking uitgevoerd in de console. Typisch, zou een systeembeheerder dit opstelling, zoals die in wordt beschreven [Automatisch account maken inschakelen](https://helpx.adobe.com/enterprise/using/automatic-account-creation.html){target=_blank}.</p></li><li><p>Als uw organisatie in een industrie is die naleving HIPAA vereist, wordt deze optie automatisch toegelaten en kan niet worden onbruikbaar gemaakt.</p></li></ul> |
|  | Geef gebruikers de optie &quot;Single Sign-On verificatie vereisen&quot; weer | <p>Als de optie &quot;Eigen aanmeldingsverificatie vereisen&quot; is uitgeschakeld, kunt u deze optie selecteren zodat gebruikers in uw organisatie kunnen kiezen of zij voor projecten die zij delen, enkelvoudige aanmeldingsverificatie willen vereisen. In dit geval wordt de optie &quot;Single Sign-On (SSO)-verificatie vereisen&quot; altijd ingeschakeld in het dialoogvenster Delen wanneer een gebruiker een koppeling naar een Analysis Workspace-project maakt. Gebruikers kunnen deze desgewenst uitschakelen.<!--or is this disabled by default?--> (Voor informatie over hoe de gebruikers projecten met gebruikers buiten de organisatie kunnen delen, zie [Een openbare koppeling delen met iedereen (geen aanmelding vereist)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Projecten delen](/help/analyze/analysis-workspace/curate-share/share-projects.md).)</p><p>Als de optie &#39;Eénmalige aanmeldingsverificatie vereisen&#39; is ingeschakeld, wordt deze optie voor het weergeven van deze verificatie aan gebruikers geselecteerd en kan deze optie niet worden uitgeschakeld.</p><p>Houd rekening met het volgende wanneer u deze optie selecteert:</p><ul><li><p>Deze optie is alleen beschikbaar als SSO in uw organisatie is geïmplementeerd. Voor informatie over hoe de systeembeheerders SSO voor uw organisatie kunnen toelaten, zie [Identiteit instellen en Single Sign-On](https://helpx.adobe.com/enterprise/using/set-up-identity.html){target=_blank}.</p><p>Als SSO voor uw organisatie wordt gevormd, controleer om te zien of wordt om het even welk soort auto-rekening verwezenlijking uitgevoerd in de console. Typisch, zou een systeembeheerder dit opstelling, zoals die in wordt beschreven [Automatisch account maken inschakelen](https://helpx.adobe.com/enterprise/using/automatic-account-creation.html){target=_blank}.</p></li><li><p>Als u deze optie selecteert en een gebruiker verkiest om enige sign-on authentificatie te vereisen, slechts kunnen de ontvangers die een gefedereerde identiteitskaart hebben en login aan Experience Cloud kunnen tot gedeelde openbare verbindingen toegang hebben.</p></li></ul> |
