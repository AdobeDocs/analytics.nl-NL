...
Zie ![ VideoCheckedOut ](/help/assets/icons/VideoCheckedOut.svg) [ voorkeur ](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/intro-to-analytics/customizing-the-ui/user-preferences){target="_blank"} voor een demo video beheren.
...
>abstract="Selecteer standaard metrisch voor vrije vormlijsten te gebruiken. Als de geselecteerde rapportreeks niet het geselecteerde gebrek metrisch bevat, schakelt de lijst automatisch aan andere primaire metrisch over."
