...
1. Selecteren [!UICONTROL **Rapporten**].
   ...
   ![Tabblad Rapporten](assets/view-prebuilt-reports.png)

1. Typ in het zoekveld de naam van het rapport dat u wilt zoeken en selecteer het in de lijst met rapporten. U kunt de rapportlijst ook doorzoeken op basis van eigenschap, eVar en gebeurtenisnummer. <!-- still true? -->
...
Enkele populairste pre-gebouwde rapporten omvatten, Stroom, Vallout, het Kanaal van de Marketing, en rapporten In real time.
