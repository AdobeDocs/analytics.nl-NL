...
Iedereen kan een [!UICONTROL Quick Segment] creëren. Nochtans, hebt u [!UICONTROL Segment Creation] toestemming in [Adobe Admin Console](https://experienceleague.adobe.com/docs/analytics/admin/admin-console/permissions/summary-tables.html?lang=en#analytics-tools) nodig om een snelle segmenten te kunnen bewaren of het te openen in [!UICONTROL Segment Builder].
...
De project-enige segmenten zijn of snelle segmenten of de projectsegmenten van de ad-hoc Werkruimte. Wanneer het uitgeven van/het openen van hen in [!UICONTROL Segment Builder], verschijnt het project-enige vakje. Als u een snel segment toepast in de builder maar niet het vakje ter beschikking stellen controleert, dan is het nog een project-slechts segment maar het kan niet meer in [!UICONTROL Quick Segment Builder] worden geopend.

![Alleen project uitgeschakeld](assets/project-only-unchecked.png)

Als u het vakje controleert en **[!UICONTROL SAVE]** klikt, is het nu een component-lijst segment.
