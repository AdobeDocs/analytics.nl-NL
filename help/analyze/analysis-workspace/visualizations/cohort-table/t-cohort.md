...
1. (Optioneel) Pas de **[!UICONTROL Cohort Table Settings]** door op het tandwielpictogram te klikken.
...
Net als andere visualisaties in Analysis Workspace kunt u een cohortvisualisatie downloaden als een CSV- of PDF-bestand. Zie voor meer informatie [PDF- of CSV-bestanden downloaden](/help/analyze/analysis-workspace/curate-share/download-send.md).
