...
U kunt de gegevens van een vrije-vormlijst door de volgende types van kolommen in Analysis Workspace sorteren:

* Elke metrische kolom

* Willekeurige dimensiekolommen (behalve voor op tekenreeks gebaseerde afmetingen)

U kunt zelfs op meerdere kolommen tegelijk sorteren.
...
* Paginaweergaven (metrisch)

* Bezoekingen (metrisch)

* Inhoudssnelheid (metrisch)
...
|---------|----------|---------|
| Dag | Dimension | 1 |
| Paginaweergaven | Metrisch | 2 |
| Bezoeken | Metrisch | 3 |
| Inhoudssnelheid | Metrisch | 4 |
